# 1 "../../../../Library/StdDriver/src/usci_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/usci_uart.c" 2
# 10 "../../../../Library/StdDriver/src/usci_uart.c"
...
# 11 "../../../../Library/StdDriver/src/usci_uart.c" 2
...
# 12 "../../../../Library/StdDriver/src/usci_uart.c" 2
...
# 13 "../../../../Library/StdDriver/src/usci_uart.c" 2
# 45 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_ClearIntFlag(UUART_T *psUUART, uint32_t u32Mask)
{

    if (u32Mask & (0x002ul))
    {
        psUUART->PROTSTS = (0x1ul << (9));
    }

    if (u32Mask & (0x004ul))
    {
        psUUART->PROTSTS = ((0x1ul << (7)) | (0x1ul << (6)) | (0x1ul << (5)));
    }

    if (u32Mask & (0x008ul))
    {
        psUUART->BUFSTS = (0x1ul << (3));
    }

    if (u32Mask & (0x010ul))
    {
        psUUART->PROTSTS = (0x1ul << (1));
    }

    if (u32Mask & (0x020ul))
    {
        psUUART->PROTSTS = (0x1ul << (2));
    }

    if (u32Mask & (0x040ul))
    {
        psUUART->PROTSTS = (0x1ul << (3));
    }

    if (u32Mask & (0x080ul))
    {
        psUUART->PROTSTS = (0x1ul << (4));
    }

}
# 105 "../../../../Library/StdDriver/src/usci_uart.c"
uint32_t UUART_GetIntFlag(UUART_T *psUUART, uint32_t u32Mask)
{
    ...
    u32Tmp1 = (u32Mask & (0x002ul));
    u32Tmp2 = (psUUART->PROTSTS & (0x1ul << (9)));
    ...
    u32Tmp1 = (u32Mask & (0x004ul));
    u32Tmp2 = (psUUART->PROTSTS & ((0x1ul << (7)) | (0x1ul << (6)) | (0x1ul << (5))));
    ...
    u32Tmp1 = (u32Mask & (0x008ul));
    u32Tmp2 = (psUUART->BUFSTS & (0x1ul << (3)));
    ...
    u32Tmp1 = (u32Mask & (0x010ul));
    u32Tmp2 = (psUUART->PROTSTS & (0x1ul << (1)));
    ...
    u32Tmp1 = (u32Mask & (0x020ul));
    u32Tmp2 = (psUUART->PROTSTS & (0x1ul << (2)));
    ...
    u32Tmp1 = (u32Mask & (0x040ul));
    u32Tmp2 = (psUUART->PROTSTS & (0x1ul << (3)));
    ...
    u32Tmp1 = (u32Mask & (0x080ul));
    u32Tmp2 = (psUUART->PROTSTS & (0x1ul << (4)));
...
# 186 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_Close(UUART_T *psUUART)
{
    psUUART->CTL = 0ul;
}
# 210 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_DisableInt(UUART_T *psUUART, uint32_t u32Mask)
{
    ...
    {
        psUUART->PROTIEN &= ~(0x1ul << (1));
    }


    if ((u32Mask & (0x004ul)) == (0x004ul))
    {
        psUUART->PROTIEN &= ~(0x1ul << (2));
    }


    if ((u32Mask & (0x008ul)) == (0x008ul))
    {
        psUUART->BUFCTL &= ~(0x1ul << (14));
    }


    if ((u32Mask & (0x010ul)) == (0x010ul))
    {
        psUUART->INTEN &= ~(0x1ul << (1));
    }


    if ((u32Mask & (0x020ul)) == (0x020ul))
    {
        psUUART->INTEN &= ~(0x1ul << (2));
    }


    if ((u32Mask & (0x040ul)) == (0x040ul))
    {
        psUUART->INTEN &= ~(0x1ul << (3));
    }


    if ((u32Mask & (0x080ul)) == (0x080ul))
    {
        psUUART->INTEN &= ~(0x1ul << (4));
    }
}
# 275 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_EnableInt(UUART_T *psUUART, uint32_t u32Mask)
{
...
# 331 "../../../../Library/StdDriver/src/usci_uart.c"
uint32_t UUART_Open(UUART_T *psUUART, uint32_t u32Baudrate)
{
    ...
    if ((psUUART == ((UUART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x90000UL))) || (psUUART == ((UUART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x92000UL))))
    {
    ...
    psUUART->LINECTL = (8ul << (8)) | (0x1ul << (0));
    psUUART->DATIN0 = (2 << (3));


    psUUART->BRGEN = ((u32MinClkDiv - 1) << (16)) |
                     ((u32MinDSCnt - 1) << (10)) |
                     ((u32PDSCnt - 1) << (8));

    psUUART->PROTCTL |= (0x1ul << (31));

    return (u32PCLKFreq / u32PDSCnt / u32MinDSCnt / u32MinClkDiv);
}
# 457 "../../../../Library/StdDriver/src/usci_uart.c"
uint32_t UUART_Read(UUART_T *psUUART, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
    uint32_t u32Count;
    ...
    for (u32Count = 0ul; u32Count < u32ReadBytes; u32Count++)
    {
        ...
        pu8RxBuf[u32Count] = (uint8_t)psUUART->RXDAT;
    }

    return u32Count;

}
# 511 "../../../../Library/StdDriver/src/usci_uart.c"
uint32_t UUART_SetLine_Config(UUART_T *psUUART, uint32_t u32Baudrate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t u32StopBits)
{
    ...
    {
        u32PDSCnt = ((psUUART->BRGEN & (0x3ul << (8))) >> (8)) + 1;
        u32MinDSCnt = ((psUUART->BRGEN & (0x1ful << (10))) >> (10)) + 1;
        u32MinClkDiv = ((psUUART->BRGEN & (0x3fful << (16))) >> (16)) + 1;
    }


    psUUART->LINECTL = (psUUART->LINECTL & ~(0xful << (8))) | u32DataWidth;
    psUUART->PROTCTL = (psUUART->PROTCTL & ~((0x1ul << (26)) | (0x1ul << (2)) |
                                             (0x1ul << (1)))) | u32Parity;
    psUUART->PROTCTL = (psUUART->PROTCTL & ~(0x1ul << (0))) | u32StopBits;

    return (u32PCLKFreq / u32PDSCnt / u32MinDSCnt / u32MinClkDiv);
}
# 636 "../../../../Library/StdDriver/src/usci_uart.c"
uint32_t UUART_Write(UUART_T *psUUART, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count;
    ...
    for (u32Count = 0ul; u32Count != u32WriteBytes; u32Count++)
    {
        ...
        while ((psUUART->BUFSTS & (0x1ul << (8))) == 0ul)
        {
            u32Delayno++;
        ...
        psUUART->TXDAT = (uint8_t)pu8TxBuf[u32Count];
    }

    return u32Count;

}
# 678 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_EnableWakeup(UUART_T *psUUART, uint32_t u32WakeupMode)
{
    psUUART->PROTCTL |= u32WakeupMode;
    psUUART->WKCTL |= (0x1ul << (0));
}
# 693 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_DisableWakeup(UUART_T *psUUART)
{
    psUUART->PROTCTL &= ~((0x1ul << (9)) | (0x1ul << (10)));
    psUUART->WKCTL &= ~(0x1ul << (0));
}
# 707 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_EnableFlowCtrl(UUART_T *psUUART)
{

    psUUART->LINECTL &= ~(0x1ul << (7));


    psUUART->CTLIN0 &= ~(0x1ul << (2));


    psUUART->PROTCTL |= (0x1ul << (3)) | (0x1ul << (4));
}
# 727 "../../../../Library/StdDriver/src/usci_uart.c"
void UUART_DisableFlowCtrl(UUART_T *psUUART)
{
