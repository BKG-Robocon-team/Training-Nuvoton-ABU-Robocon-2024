# 1 "../../../../Library/StdDriver/src/ebi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/ebi.c" 2
# 10 "../../../../Library/StdDriver/src/ebi.c"
...
# 11 "../../../../Library/StdDriver/src/ebi.c" 2
# 55 "../../../../Library/StdDriver/src/ebi.c"
void EBI_Open(uint32_t u32Bank, uint32_t u32DataWidth, uint32_t u32TimingClass, uint32_t u32BusMode, uint32_t u32CSActiveLevel)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000UL) + 0x10000UL))->CTL0 + (uint32_t)u32Bank * 0x10U;
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000UL) + 0x10000UL))->TCTL0 + (uint32_t)u32Bank * 0x10U;
    ...
    *pu32EBICTL |= u32BusMode;
    ...
    {
        case 0x0UL:
            *pu32EBICTL = (*pu32EBICTL & ~((0x7ul << (8)) | (0x7ul << (16)))) |
                          (0x0UL << (8)) |
...
# 146 "../../../../Library/StdDriver/src/ebi.c"
void EBI_Close(uint32_t u32Bank)
{
    uint32_t u32Index = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000UL) + 0x10000UL))->CTL0 + u32Bank * 0x10U;
    volatile uint32_t *pu32EBICTL = (uint32_t *)(u32Index);

    *pu32EBICTL &= ~(0x1ul << (0));
}
# 175 "../../../../Library/StdDriver/src/ebi.c"
void EBI_SetBusTiming(uint32_t u32Bank, uint32_t u32TimingConfig, uint32_t u32MclkDiv)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000UL) + 0x10000UL))->CTL0 + (uint32_t)u32Bank * 0x10U;
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000UL) + 0x10000UL))->TCTL0 + (uint32_t)u32Bank * 0x10U;
