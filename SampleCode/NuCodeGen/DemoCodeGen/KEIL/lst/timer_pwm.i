# 1 "../../../../Library/StdDriver/src/timer_pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/timer_pwm.c" 2
...
# 10 "../../../../Library/StdDriver/src/timer_pwm.c" 2
# 36 "../../../../Library/StdDriver/src/timer_pwm.c"
uint32_t TPWM_ConfigOutputFreqAndDuty(TIMER_T *timer, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    timer->PWMCTL = (timer->PWMCTL & ~(0x1ul << (3))) | ((0UL) << (3));


    ((timer)->PWMCLKPSC = ((u32Prescaler - 1UL)));

    ((timer)->PWMPERIOD = ((u32Period - 1UL)));
    ...
    ((timer)->PWMCMPDAT = (u32CMP));
    return (u32TargetFreq);
}
# 100 "../../../../Library/StdDriver/src/timer_pwm.c"
void TPWM_EnableCounter(TIMER_T *timer)
{
    timer->PWMCTL |= (0x1ul << (0));
}
# 113 "../../../../Library/StdDriver/src/timer_pwm.c"
void TPWM_DisableCounter(TIMER_T *timer)
{
    timer->PWMCTL &= ~(0x1ul << (0));
}
# 133 "../../../../Library/StdDriver/src/timer_pwm.c"
void TPWM_EnableTrigger(TIMER_T *timer, uint32_t u32TargetMask, uint32_t u32Condition)
{
    timer->PWMTRGCTL &= ~((0x1ul << (8)) | (0x1ul << (7)) | (0x1ul << (9)) | (0x3ul << (0)));
    timer->PWMTRGCTL |= (u32TargetMask) | (u32Condition);
}
# 151 "../../../../Library/StdDriver/src/timer_pwm.c"
void TPWM_DisableTrigger(TIMER_T *timer, uint32_t u32TargetMask)
{
