...
# 10 "../../../../Library/StdDriver/src/retarget.c"
...
# 11 "../../../../Library/StdDriver/src/retarget.c" 2
...
# 59 "../../../../Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 88 "../../../../Library/StdDriver/src/retarget.c"
...
{
# 116 "../../../../Library/StdDriver/src/retarget.c"
}
# 171 "../../../../Library/StdDriver/src/retarget.c"
int32_t SH_Return(int32_t n32In_R0, int32_t n32In_R1, int32_t *pn32Out_R0);
int32_t SH_Return(int32_t n32In_R0, int32_t n32In_R1, int32_t *pn32Out_R0)
{
    return 0;
}
# 184 "../../../../Library/StdDriver/src/retarget.c"
    __attribute__((weak))
...
uint32_t ProcessHardFault(uint32_t lr, uint32_t msp, uint32_t psp)
{
    uint32_t *sp;
    uint32_t inst;
# 202 "../../../../Library/StdDriver/src/retarget.c"
        if (lr & 4UL)
        {
            sp = (uint32_t *)psp;
        }
...
# 225 "../../../../Library/StdDriver/src/retarget.c"
    inst = (*((vu16 *) (sp[6])));
...
# 256 "../../../../Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
...
# 346 "../../../../Library/StdDriver/src/retarget.c"
__attribute__((weak)) void SendChar(int ch)
{
# 379 "../../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 392 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 443 "../../../../Library/StdDriver/src/retarget.c"
    while (1)
    {
...
# 464 "../../../../Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 478 "../../../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (28))) != 0U);
}
# 491 "../../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 546 "../../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 638 "../../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 658 "../../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
