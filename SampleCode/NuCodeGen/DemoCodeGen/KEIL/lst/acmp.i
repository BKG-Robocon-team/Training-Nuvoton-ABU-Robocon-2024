# 1 "../../../../Library/StdDriver/src/acmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/acmp.c" 2
# 10 "../../../../Library/StdDriver/src/acmp.c"
...
# 11 "../../../../Library/StdDriver/src/acmp.c" 2
# 45 "../../../../Library/StdDriver/src/acmp.c"
void ACMP_Open(ACMP_T *acmp, uint32_t u32ChNum, uint32_t u32NegSrc, uint32_t u32HysSel)
{
    acmp->CTL[u32ChNum] = (acmp->CTL[u32ChNum] & (~((0x3ul << (4)) | (0x3ul << (24))))) | (u32NegSrc | u32HysSel | (0x1ul << (0)));
}
# 59 "../../../../Library/StdDriver/src/acmp.c"
void ACMP_Close(ACMP_T *acmp, uint32_t u32ChNum)
{
    acmp->CTL[u32ChNum] &= (~(0x1ul << (0)));
}
