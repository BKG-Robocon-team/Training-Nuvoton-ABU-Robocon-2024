# 1 "../../../../Library/StdDriver/src/lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/lcd.c" 2
...
# 10 "../../../../Library/StdDriver/src/lcd.c" 2
# 29 "../../../../Library/StdDriver/src/lcd.c"
static uint32_t g_LCDFrameRate;
# 85 "../../../../Library/StdDriver/src/lcd.c"
uint32_t LCD_Open(S_LCD_CFG_T *pLCDCfg)
{
    uint32_t u32ComNum, u32FreqLCD, u32FreqDiv;


    do{ ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->CTL &= ~(0x1ul << (0)); while(((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->CTL & (0x1ul << (31))) {} }while(0);


    LCD_SetAllPixels(0);


    ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET & ~((0x7ul << (2)) | (0x3ul << (0)))) | (pLCDCfg->u32ComDuty | pLCDCfg->u32BiasLevel);


    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET & ~((0x1ul << (5))|(0x1ul << (6)))) | (pLCDCfg->u32WaveformType));


    ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->INTEN = pLCDCfg->u32IntSrc;


    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | (pLCDCfg->u32DrivingMode));


    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x3ul << (0))) | (pLCDCfg->u32VSrc));


    if (pLCDCfg->u32VSrc == (2ul << (0)))
    {
        CLK_EnableModuleClock(((((2) & 0x03) << 30)|((((15)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((25) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
    }
    else
    {
        CLK_DisableModuleClock(((((2) & 0x03) << 30)|((((15)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((25) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
    }
# 134 "../../../../Library/StdDriver/src/lcd.c"
    u32ComNum = ((pLCDCfg->u32ComDuty & (0x7ul << (2))) >> (2)) + 1;

    if ((pLCDCfg->u32WaveformType & (0x1ul << (5))) == (0x1ul << (5)))
    {
        ...
        else
        {
            ...
            (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET & ~(0x3fful << (8))) | (((u32FreqDiv)-1) << (8)));
...
# 209 "../../../../Library/StdDriver/src/lcd.c"
void LCD_SetPixel(uint32_t u32Com, uint32_t u32Seg, uint32_t u32OnFlag)
{
    ...
    if (seg_num < 11)
    {
        if (u32OnFlag)
        {
            ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DATA[seg_num] |= ((uint32_t)(1 << u32Com) << seg_shift);
        }
        else
        {
            ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DATA[seg_num] &= (~((uint32_t)(1 << u32Com) << seg_shift));
...
# 236 "../../../../Library/StdDriver/src/lcd.c"
void LCD_SetAllPixels(uint32_t u32OnOff)
{
    uint32_t i, u32Value;
    ...
    for (i = 0; i < 11; i++)
        ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DATA[i] = u32Value;
}
# 262 "../../../../Library/StdDriver/src/lcd.c"
uint32_t LCD_EnableBlink(uint32_t u32ms)
{
    uint32_t u32OneCountPeriod, u32TargetCounts;

    if ((((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET & (0x1ul << (5))) == (0x1ul << (5)))
    {

        u32OneCountPeriod = (1000 * 2) / g_LCDFrameRate;
    }
    else
    {

        u32OneCountPeriod = 1000 / g_LCDFrameRate;
    }
    ...
    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->FSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->FSET & ~(0x3fful << (8))) | (((u32TargetCounts)-1) << (8)));


    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->FSET |= (0x1ul << (0)));
...
# 313 "../../../../Library/StdDriver/src/lcd.c"
void LCD_EnableInt(uint32_t u32IntSrc)
{
    ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->INTEN |= (u32IntSrc);
}
# 327 "../../../../Library/StdDriver/src/lcd.c"
void LCD_DisableInt(uint32_t u32IntSrc)
{
    ((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->INTEN &= ~(u32IntSrc);
}
# 349 "../../../../Library/StdDriver/src/lcd.c"
void LCD_SetSavingMode(uint32_t u32PowerSavingMode, uint32_t u32PowerSavingLevel)
{
    ...
    u32FLCDDiv = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->PSET & (0x3fful << (8))) >> (8);


    if (((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2) & (0x1ul << (24))) == 0)
    {
        u32LCDClock = (38400UL);
    }
    else
    ...
    else
    {
        ...
        if (u32PowerSavingMode == (0ul))
        {

            switch (u32PowerSavingLevel)
            {
                case LCD_PWR_SAVING_LEVEL0:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((5ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((0ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[0])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[0])-1) << (12)));
                    break;

                case LCD_PWR_SAVING_LEVEL1:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((5ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((0ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[3])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[3])-1) << (12)));
                    break;

                case LCD_PWR_SAVING_LEVEL2:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((5ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((1ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[0])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[0])-1) << (12)));
                    break;

                case LCD_PWR_SAVING_LEVEL3:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((1ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((0ul << (5))));
                    break;
        ...
        else
        {
            ...
            {
                case LCD_PWR_SAVING_LEVEL0:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((6ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((1ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[3])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[3])-1) << (12)));
                    break;
                ...
                case LCD_PWR_SAVING_LEVEL1:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((6ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((1ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[2])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[2])-1) << (12)));
                    break;

                case LCD_PWR_SAVING_LEVEL2:
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~((0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4)))) | ((6ul << (2))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0x1ul << (5))) | ((1ul << (5))));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (8))) | (((u32PSVTBoundary[1])-1) << (8)));
                    (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET = (((LCD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x7B000UL))->DSET & ~(0xful << (12))) | (((u32PSVTBoundary[1])-1) << (12)));
                    break;
