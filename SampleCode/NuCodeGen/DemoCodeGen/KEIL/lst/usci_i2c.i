# 1 "../../../../Library/StdDriver/src/usci_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/usci_i2c.c" 2
...
# 10 "../../../../Library/StdDriver/src/usci_i2c.c" 2
# 34 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_Open(UI2C_T *ui2c, uint32_t u32BusClock)
{
    uint32_t u32ClkDiv;
    uint32_t u32Pclk;

    if ((ui2c == ((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x90000UL))) || (ui2c == ((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x92000UL))))
    {
    ...
    ui2c->CTL = (ui2c->CTL & ~(0x7ul << (0))) | (4U << (0));
...
# 77 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_Close(UI2C_T *ui2c)
{

    ui2c->CTL &= ~(0x7ul << (0));
}
# 91 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_ClearTimeoutFlag(UI2C_T *ui2c)
{
    ui2c->PROTSTS = (0x1ul << (5));
}
# 108 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_Trigger(UI2C_T *ui2c, uint8_t u8Start, uint8_t u8Stop, uint8_t u8Ptrg, uint8_t u8Ack)
{
    uint32_t u32Reg = 0U;
...
# 154 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_DisableInt(UI2C_T *ui2c, uint32_t u32Mask)
{
...
# 215 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_EnableInt(UI2C_T *ui2c, uint32_t u32Mask)
{
...
# 269 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_GetBusClockFreq(UI2C_T *ui2c)
{
    uint32_t u32Divider;
    uint32_t u32Pclk;
...
# 298 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_SetBusClockFreq(UI2C_T *ui2c, uint32_t u32BusClock)
{
    uint32_t u32ClkDiv;
    uint32_t u32Pclk;
...
# 340 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_GetIntFlag(UI2C_T *ui2c, uint32_t u32Mask)
{
...
# 421 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_ClearIntFlag(UI2C_T *ui2c, uint32_t u32Mask)
{
...
# 475 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_GetData(UI2C_T *ui2c)
{
    return (ui2c->RXDAT);
}
# 489 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_SetData(UI2C_T *ui2c, uint8_t u8Data)
{
    ui2c->TXDAT = u8Data;
}
# 507 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_SetSlaveAddr(UI2C_T *ui2c, uint8_t u8SlaveNo, uint16_t u16SlaveAddr, uint8_t u8GCMode)
{
    if (u8SlaveNo)
    {
...
# 532 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_SetSlaveAddrMask(UI2C_T *ui2c, uint8_t u8SlaveNo, uint16_t u16SlaveAddrMask)
{
    if (u8SlaveNo)
    {
...
# 553 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_EnableTimeout(UI2C_T *ui2c, uint32_t u32TimeoutCnt)
{
    ui2c->PROTCTL = (ui2c->PROTCTL & ~(0x3fful << (16))) | (u32TimeoutCnt << (16));
    ui2c->BRGEN = (ui2c->BRGEN & ~(0x1ul << (5))) | (0x1ul << (4));
}
# 567 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_DisableTimeout(UI2C_T *ui2c)
{
    ui2c->PROTCTL &= ~(0x3fful << (16));
    ui2c->BRGEN &= ~(0x1ul << (4));
}
# 584 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_EnableWakeup(UI2C_T *ui2c, uint8_t u8WakeupMode)
{
    ui2c->WKCTL = (ui2c->WKCTL & ~(0x1ul << (1))) | (u8WakeupMode | (0x1ul << (0)));
}
# 597 "../../../../Library/StdDriver/src/usci_i2c.c"
void UI2C_DisableWakeup(UI2C_T *ui2c)
{
    ui2c->WKCTL &= ~(0x1ul << (0));
}
# 616 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_WriteByte(UI2C_T *ui2c, uint8_t u8SlaveAddr, const uint8_t u8Data)
{
...
# 690 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_WriteMultiBytes(UI2C_T *ui2c, uint8_t u8SlaveAddr, const uint8_t *pu8Data, uint32_t u32WLen)
{
...
# 759 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_WriteByteOneReg(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, const uint8_t u8Data)
{
    uint8_t u8Xfering = 1U, u8Err = 0U, u8Ctrl = 0U;
    uint32_t u32TXLen = 0U;
...
# 839 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_WriteMultiBytesOneReg(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, const uint8_t *pu8Data, uint32_t u32WLen)
{
    uint8_t u8Xfering = 1U, u8Ctrl = 0U;
    uint32_t u32TXLen = 0U;
...
# 918 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_WriteByteTwoRegs(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, const uint8_t u8Data)
{
    uint8_t u8Xfering = 1U, u8Err = 0U, u8Ctrl = 0U;
    uint32_t u32TXLen = 0U;
...
# 1003 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_WriteMultiBytesTwoRegs(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, const uint8_t *pu8Data, uint32_t u32WLen)
{
...
# 1088 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_ReadByte(UI2C_T *ui2c, uint8_t u8SlaveAddr)
{
...
# 1166 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_ReadMultiBytes(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint8_t *pu8Rdata, uint32_t u32RLen)
{
    uint8_t u8Xfering = 1U, u8Ctrl = 0U;
...
# 1249 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_ReadByteOneReg(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr)
{
...
# 1355 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_ReadMultiBytesOneReg(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t *pu8Rdata, uint32_t u32RLen)
{
    uint8_t u8Xfering = 1U, u8Ctrl = 0U;
    uint32_t u32RXLen = 0U;
...
# 1459 "../../../../Library/StdDriver/src/usci_i2c.c"
uint8_t UI2C_ReadByteTwoRegs(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr)
{
...
# 1572 "../../../../Library/StdDriver/src/usci_i2c.c"
uint32_t UI2C_ReadMultiBytesTwoRegs(UI2C_T *ui2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t *pu8Rdata, uint32_t u32RLen)
{
    uint8_t u8Xfering = 1U, u8Addr = 1U, u8Ctrl = 0U;
    uint32_t u32RXLen = 0U;
