# 1 "../../../../Library/StdDriver/src/sys.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/sys.c" 2
...
# 10 "../../../../Library/StdDriver/src/sys.c" 2
# 38 "../../../../Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->RSTSTS |= u32Src;
}
...
uint32_t SYS_GetBODStatus(void)
{
    return ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL & (0x1ul << (6))) >> (6));
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->RSTSTS);
}
...
uint32_t SYS_IsRegLocked(void)
{
    return !(((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->REGLCTL & 0x1UL);
}
...
uint32_t SYS_ReadPDID(void)
{
    return ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID;
}
...
void SYS_ResetChip(void)
{
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (0));
}
...
void SYS_ResetCPU(void)
{
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (1));
}
# 144 "../../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{

    *(volatile uint32_t *)((uint32_t)&((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST0 + (u32ModuleIndex >> 24UL)) |= 1UL << (u32ModuleIndex & 0x00ffffffUL);


    *(volatile uint32_t *)((uint32_t)&((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST0 + (u32ModuleIndex >> 24UL)) &= ~(1UL << (u32ModuleIndex & 0x00ffffffUL));
}
# 170 "../../../../Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL & ~(0x1ul << (3))) | i32Mode;


    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL & ~(0x7ul << (16))) | u32BODLevel;
}
...
# 200 "../../../../Library/StdDriver/src/sys.c"
void SYS_SetPowerLevel(uint32_t u32PowerLevel)
{

    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PLCTL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PLCTL & (~(0x3ul << (0)))) | (u32PowerLevel);

    while (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PLSTS & (0x1ul << (0)));
}
