# 1 "../../../../Library/StdDriver/src/dac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/dac.c" 2
...
# 10 "../../../../Library/StdDriver/src/dac.c" 2
# 43 "../../../../Library/StdDriver/src/dac.c"
void DAC_Open(DAC_T *dac,
              uint32_t u32Ch,
              uint32_t u32TrgSrc)
{
    dac->CTL &= ~((0x3ul << (12)) | (0x7ul << (5)) | (0x1ul << (4)));
    dac->CTL |= (u32TrgSrc | (0x1ul << (0)));
}
...
# 70 "../../../../Library/StdDriver/src/dac.c"
uint32_t DAC_SetDelayTime(DAC_T *dac, uint32_t u32Delay)
{
