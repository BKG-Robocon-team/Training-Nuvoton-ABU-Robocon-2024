...
# 70 "../../../../Library/StdDriver/src/crypto.c"
...
void AES_SetKey(CRPT_T *crpt, uint32_t u32Channel, uint32_t au32Keys[], uint32_t u32KeySize)
{
    ...
    {
        (*((volatile unsigned int *)(u32KeyRegAddr))=(au32Keys[u32Idx]));
        u32KeyRegAddr += 4UL;
    }
}
...
void AES_SetInitVect(CRPT_T *crpt, uint32_t u32Channel, uint32_t au32IV[])
{
    ...
    {
        (*((volatile unsigned int *)(u32KeyRegAddr))=(au32IV[u32Idx]));
        u32KeyRegAddr += 4UL;
    }
}
# 147 "../../../../Library/StdDriver/src/crypto.c"
                        ...
                        uint32_t u32DstAddr, uint32_t u32TransCnt)
{
    ...
    (*((volatile unsigned int *)(u32RegAddr))=(u32SrcAddr));

    u32RegAddr = (uint32_t)&crpt->AES_DADDR + (u32Channel * 0x3CUL);
    (*((volatile unsigned int *)(u32RegAddr))=(u32DstAddr));

    u32RegAddr = (uint32_t)&crpt->AES_CNT + (u32Channel * 0x3CUL);
    (*((volatile unsigned int *)(u32RegAddr))=(u32TransCnt));
}
