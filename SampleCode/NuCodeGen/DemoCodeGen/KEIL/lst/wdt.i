# 1 "../../../../Library/StdDriver/src/wdt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/wdt.c" 2
...
# 10 "../../../../Library/StdDriver/src/wdt.c" 2
# 50 "../../../../Library/StdDriver/src/wdt.c"
void WDT_Open(uint32_t u32TimeoutInterval,
              uint32_t u32ResetDelay,
              uint32_t u32EnableReset,
              uint32_t u32EnableWakeup)
{
    ((WDT_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x00000UL))->ALTCTL = u32ResetDelay;

    ((WDT_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x00000UL))->CTL = u32TimeoutInterval | (0x1ul << (7)) |
               (u32EnableReset << (1)) |
               (u32EnableWakeup << (4));
    return;
}
