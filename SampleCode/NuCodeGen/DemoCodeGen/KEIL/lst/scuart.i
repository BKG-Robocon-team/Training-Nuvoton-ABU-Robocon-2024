# 1 "../../../../Library/StdDriver/src/scuart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/scuart.c" 2
...
# 9 "../../../../Library/StdDriver/src/scuart.c" 2

static uint32_t SCUART_GetClock(SC_T *sc);
# 20 "../../../../Library/StdDriver/src/scuart.c"
int32_t g_SCUART_i32ErrCode = 0;
# 30 "../../../../Library/StdDriver/src/scuart.c"
...
static uint32_t SCUART_GetClock(SC_T *sc)
{
    ...
    if (sc == ((SC_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x50000UL)))
    {
        u32Num = 0UL;
    }
    else
    ...
    u32ClkSrc = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL3 >> (2UL * u32Num)) & (0x3ul << (0));
    ...
    u32Clk /= (((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV1 >> (8UL * u32Num)) & (0xfful << (0))) + 1UL);


    return u32Clk;
}
# 104 "../../../../Library/StdDriver/src/scuart.c"
uint32_t SCUART_Open(SC_T *sc, uint32_t u32baudrate)
{
    ...
    sc->CTL = (0x1ul << (0)) | (0x1ul << (15));

    sc->UARTCTL = (0UL) | ((0x1ul << (6))) | (0x1ul << (0));
    sc->ETUCTL = u32Div;

    return (u32Clk / (u32Div + 1UL));
}
# 128 "../../../../Library/StdDriver/src/scuart.c"
uint32_t SCUART_Read(SC_T *sc, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
    ...
    {
        if (((sc)->STATUS & (0x1ul << (1))))
        {
            break;
        }

        pu8RxBuf[u32Count] = (uint8_t)((sc)->DAT);
    }

    return u32Count;
}
# 168 "../../../../Library/StdDriver/src/scuart.c"
uint32_t SCUART_SetLineConfig(SC_T *sc, uint32_t u32Baudrate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t u32StopBits)
{
    ...
    sc->CTL = u32StopBits | (0x1ul << (0));

    sc->UARTCTL = u32Parity | u32DataWidth | (0x1ul << (0));

    return (u32Clk / (u32Div + 1UL));
}
# 201 "../../../../Library/StdDriver/src/scuart.c"
void SCUART_SetTimeoutCnt(SC_T *sc, uint32_t u32TOC)
{
    sc->RXTOUT = u32TOC;
}
# 216 "../../../../Library/StdDriver/src/scuart.c"
uint32_t SCUART_Write(SC_T *sc, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    ...
    for (u32Count = 0UL; u32Count != u32WriteBytes; u32Count++)
    {
        ...
        while (((sc)->STATUS & (0x1ul << (10))))
        {

            if (i++ > u32Delay)
            {
                g_SCUART_i32ErrCode = (-1L);
                return u32Count;
            }
        }
