...
# 40 "../../../../Library/StdDriver/src/uart.c"
void UART_ClearIntFlag(UART_T *uart, uint32_t u32InterruptFlag)
{
...
# 90 "../../../../Library/StdDriver/src/uart.c"
void UART_Close(UART_T *uart)
{
    uart->INTEN = 0ul;
}
# 104 "../../../../Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T *uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 128 "../../../../Library/StdDriver/src/uart.c"
void UART_DisableInt(UART_T *uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN &= ~ (u32InterruptFlag));
}
# 143 "../../../../Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T *uart)
{
...
# 174 "../../../../Library/StdDriver/src/uart.c"
void UART_EnableInt(UART_T *uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN |= (u32InterruptFlag));
}
# 190 "../../../../Library/StdDriver/src/uart.c"
void UART_Open(UART_T *uart, uint32_t u32BaudRate)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t au32ClkTbl[6ul] = {12000000ul, 0ul, 32768ul, (48000000UL), 0ul, (38400UL)};

    if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))
    {

        u32UartClkSrcSel = ((uint32_t)(((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (24)))) >> (24);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (0xful << (8))) >> (8);
    }
    else if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL)))
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (28))) >> (28);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (0xful << (12))) >> (12);
    }
    else if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x32000UL)))
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL3 & (0x7ul << (24))) >> (24);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV4 & (0xful << (0))) >> (0);
    }
    else if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x33000UL)))
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL3 & (0x7ul << (28))) >> (28);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV4 & (0xful << (4))) >> (4);
    }
    ...
    if (u32UartClkSrcSel == 4ul)
    {
        ...
        if ((uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))) || (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x32000UL))))
        {
    ...
    if (u32BaudRate != 0ul)
    {
        ...
        u32Baud_Div = (((((au32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32BaudRate)/2ul)) / (u32BaudRate))-2ul);
...
# 284 "../../../../Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T *uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
    uint32_t u32Count;
...
# 347 "../../../../Library/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T *uart, uint32_t u32BaudRate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t u32StopBits)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t au32ClkTbl[6ul] = {12000000ul, 0ul, 32768ul, (48000000UL), 0, (38400UL)};

    if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (24))) >> (24);
...
# 433 "../../../../Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T *uart, uint32_t u32TOC)
{
...
# 455 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T *uart, uint32_t u32BuadRate, uint32_t u32Direction)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t au32ClkTbl[6ul] = {12000000ul, 0ul, 32768ul, (48000000UL), 0ul, (38400UL)};
    ...
    if (uart == ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))
    {
    ...
    else if (uart == ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL)))
    {
    ...
    else if (uart == ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x32000UL)))
    {
    ...
    if (u32BuadRate != 0ul)
    {
        ...
        u32Baud_Div = (((((au32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32BuadRate)*8ul)) / (u32BuadRate) >> 4ul)-2ul);
...
# 558 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T *uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 581 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectLINMode(UART_T *uart, uint32_t u32Mode, uint32_t u32BreakLength)
{
...
# 647 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectSingleWireMode(UART_T *uart)
{
