# 1 "../../../../Library/StdDriver/src/usci_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/usci_spi.c" 2
...
# 10 "../../../../Library/StdDriver/src/usci_spi.c" 2
# 43 "../../../../Library/StdDriver/src/usci_spi.c"
uint32_t USPI_Open(USPI_T *psUSPI, uint32_t u32MasterSlave, uint32_t u32SPIMode, uint32_t u32DataWidth, uint32_t u32BusClock)
{
    ...
    if ((psUSPI == (USPI_T *)((USPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x90000UL))) || (psUSPI == (USPI_T *)((USPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x92000UL))))
    {
    ...
    psUSPI->LINECTL &= ~(0xful << (8));
    psUSPI->LINECTL |= (u32DataWidth << (8));


    psUSPI->LINECTL &= ~(0x1ul << (0));


    if (u32MasterSlave == (0x0ul))
    {
        psUSPI->LINECTL |= (0x1ul << (7));
    }
    else
    {
        psUSPI->CTLIN0 |= (0x1ul << (2));
    }


    psUSPI->PROTCTL &= ~((0x3ul << (6)) | (0x1ul << (3)) | (0x1ul << (0)));
    psUSPI->PROTCTL |= (u32MasterSlave | u32SPIMode);


    psUSPI->BRGEN &= ~(0x3fful << (16));
    psUSPI->BRGEN |= (u32ClkDiv << (16));
    psUSPI->PROTCTL |= (0x1ul << (31));
...
void USPI_DisableAutoSS(USPI_T *psUSPI)
{
    psUSPI->PROTCTL &= ~((0x1ul << (3)) | (0x1ul << (2)));
}
# 153 "../../../../Library/StdDriver/src/usci_spi.c"
void USPI_EnableAutoSS(USPI_T *psUSPI, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    psUSPI->LINECTL = (psUSPI->LINECTL & ~(0x1ul << (7))) | u32ActiveLevel;
    psUSPI->PROTCTL |= (0x1ul << (3));
}
...
uint32_t USPI_SetBusClock(USPI_T *psUSPI, uint32_t u32BusClock)
{
    ...
    if ((psUSPI == ((USPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x90000UL))) || (psUSPI == ((USPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x92000UL))))
    {
        u32Pclk = CLK_GetPCLK0Freq();
    }
    else
...
uint32_t USPI_GetBusClock(USPI_T *psUSPI)
{
    ...
    u32ClkDiv = (psUSPI->BRGEN & (0x3fful << (16))) >> (16);
...
# 229 "../../../../Library/StdDriver/src/usci_spi.c"
void USPI_EnableInt(USPI_T *psUSPI, uint32_t u32Mask)
{

    if ((u32Mask & (0x001ul)) == (0x001ul))
    {
        psUSPI->PROTIEN |= (0x1ul << (0));
    }
    else {}
    ...
    {
        psUSPI->BUFCTL |= (0x1ul << (6));
    }
    else {}


    if ((u32Mask & (0x020ul)) == (0x020ul))
    {
        psUSPI->BUFCTL |= (0x1ul << (14));
    }
    else {}
    ...
    {
        psUSPI->INTEN |= (0x1ul << (4));
    }
    else {}
}
# 319 "../../../../Library/StdDriver/src/usci_spi.c"
void USPI_DisableInt(USPI_T *psUSPI, uint32_t u32Mask)
{
...
# 410 "../../../../Library/StdDriver/src/usci_spi.c"
uint32_t USPI_GetIntFlag(USPI_T *psUSPI, uint32_t u32Mask)
{
    uint32_t u32TmpFlag;
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (8));

    if (((u32Mask & (0x001ul)) == (0x001ul)) && (u32TmpFlag == (0x1ul << (8))))
    {
        u32IntFlag |= (0x001ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (9));

    if (((u32Mask & (0x002ul)) == (0x002ul)) && (u32TmpFlag == (0x1ul << (9))))
    {
        u32IntFlag |= (0x002ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (5));

    if (((u32Mask & (0x004ul)) == (0x004ul)) && (u32TmpFlag == (0x1ul << (5))))
    {
        u32IntFlag |= (0x004ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (6));

    if (((u32Mask & (0x008ul)) == (0x008ul)) && (u32TmpFlag == (0x1ul << (6))))
    {
        u32IntFlag |= (0x008ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (11));

    if (((u32Mask & (0x010ul)) == (0x010ul)) && (u32TmpFlag == (0x1ul << (11))))
    {
        u32IntFlag |= (0x010ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (3));

    if (((u32Mask & (0x020ul)) == (0x020ul)) && (u32TmpFlag == (0x1ul << (3))))
    {
        u32IntFlag |= (0x020ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (1));

    if (((u32Mask & (0x040ul)) == (0x040ul)) && (u32TmpFlag == (0x1ul << (1))))
    {
        u32IntFlag |= (0x040ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (2));

    if (((u32Mask & (0x080ul)) == (0x080ul)) && (u32TmpFlag == (0x1ul << (2))))
    {
        u32IntFlag |= (0x080ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (3));

    if (((u32Mask & (0x100ul)) == (0x100ul)) && (u32TmpFlag == (0x1ul << (3))))
    {
        u32IntFlag |= (0x100ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (4));

    if (((u32Mask & (0x200ul)) == (0x200ul)) && (u32TmpFlag == (0x1ul << (4))))
    {
        u32IntFlag |= (0x200ul);
    }
    else {}
...
# 526 "../../../../Library/StdDriver/src/usci_spi.c"
void USPI_ClearIntFlag(USPI_T *psUSPI, uint32_t u32Mask)
{

    if ((u32Mask & (0x001ul)) == (0x001ul))
    {
        psUSPI->PROTSTS = (0x1ul << (8));
    }
    else {}
    ...
    if ((u32Mask & (0x200ul)) == (0x200ul))
    {
        psUSPI->PROTSTS = (0x1ul << (4));
    }
    else {}
}
# 613 "../../../../Library/StdDriver/src/usci_spi.c"
uint32_t USPI_GetStatus(USPI_T *psUSPI, uint32_t u32Mask)
{
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (17));

    if (((u32Mask & (0x01ul)) == (0x01ul)) && (u32TmpFlag & (0x1ul << (17))))
    {
        u32Flag |= (0x01ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (0));

    if (((u32Mask & (0x02ul)) == (0x02ul)) && (u32TmpFlag == (0x1ul << (0))))
    {
        u32Flag |= (0x02ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (1));

    if (((u32Mask & (0x04ul)) == (0x04ul)) && (u32TmpFlag == (0x1ul << (1))))
    {
        u32Flag |= (0x04ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (8));

    if (((u32Mask & (0x08ul)) == (0x08ul)) && (u32TmpFlag == (0x1ul << (8))))
    {
        u32Flag |= (0x08ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->BUFSTS & (0x1ul << (9));

    if (((u32Mask & (0x10ul)) == (0x10ul)) && (u32TmpFlag == (0x1ul << (9))))
    {
        u32Flag |= (0x10ul);
    }
    else {}
    ...
    u32TmpFlag = psUSPI->PROTSTS & (0x1ul << (16));

    if (((u32Mask & (0x20ul)) == (0x20ul)) && (u32TmpFlag & (0x1ul << (16))))
    {
        u32Flag |= (0x20ul);
    }
    else {}
