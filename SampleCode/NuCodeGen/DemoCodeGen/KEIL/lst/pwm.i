# 1 "../../../../Library/StdDriver/src/pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/pwm.c" 2
...
# 10 "../../../../Library/StdDriver/src/pwm.c" 2
# 35 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_ConfigCaptureChannel(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    uint32_t u32Src;
    ...
    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x52E0 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x52A0 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x52B0 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x51E0 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x51A0
            || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xfff0) == 0x51B0)
    {
        if (pwm == ((PWM_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x18000UL)))
        {
            u32Src = (0x1UL<<(0));
        }
        else
    ...
    {
        if (pwm == ((PWM_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x18000UL)))
            u32Src = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (0));
        else
            u32Src = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (1));
    }
    ...
    ((pwm)->CLKPSC[(u32ChannelNum) >> 1UL] = ((uint32_t)u16Prescale));


    (pwm)->CTL1 = ((pwm)->CTL1 & ~((0x3ul << (0)) << ((u32ChannelNum >> 1UL) << 2UL))) | (1UL << ((u32ChannelNum >> 1UL) << 2UL));

    ((pwm)->PERIOD[(((u32ChannelNum) >> 1UL) << 1UL)] = (u16CNR));

    return (u32NearestUnitTimeNsec);
}
# 139 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_ConfigOutputChannel(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    uint32_t u32Src;
    uint32_t u32PWMClockSrc;
    ...
    for (u16Prescale = 1UL; u16Prescale < 0xFFFUL; u16Prescale++)
    {
    ...
    if (u32DutyCycle)
    {
        if (u32DutyCycle >= 100UL)
            ((pwm)->CMPDAT[(u32ChannelNum)] = (u16CNR));
        else
            ((pwm)->CMPDAT[(u32ChannelNum)] = (u32DutyCycle * (u16CNR + 1UL) / 100UL));

        (pwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (pwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum << 1UL) + (16)));
        (pwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (pwm)->WGCTL1 |= ((2UL) << ((u32ChannelNum << 1UL) + (16)));
    }
    else
    {
        ((pwm)->CMPDAT[(u32ChannelNum)] = (0UL));
        (pwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (pwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum << 1UL) + (0)));
        (pwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (pwm)->WGCTL1 |= ((2UL) << ((u32ChannelNum << 1UL) + (16)));
    }
...
# 246 "../../../../Library/StdDriver/src/pwm.c"
void PWM_Start(PWM_T *pwm, uint32_t u32ChannelMask)
{
    uint32_t i;
...
# 269 "../../../../Library/StdDriver/src/pwm.c"
void PWM_Stop(PWM_T *pwm, uint32_t u32ChannelMask)
{
    uint32_t i;
...
# 292 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ForceStop(PWM_T *pwm, uint32_t u32ChannelMask)
{
    uint32_t i;
...
# 321 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if (u32ChannelNum < 4UL)
    {
        (pwm)->EADCTS0 &= ~(((0xful << (0))) << (u32ChannelNum << 3UL));
        (pwm)->EADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum << 3UL));
    }
    else
    {
        (pwm)->EADCTS1 &= ~(((0xful << (0))) << ((u32ChannelNum - 4UL) << 3UL));
        (pwm)->EADCTS1 |= (((0x1ul << (7)) | u32Condition) << ((u32ChannelNum - 4UL) << 3UL));
    }
}
# 343 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum)
{
    if (u32ChannelNum < 4UL)
    {
        (pwm)->EADCTS0 &= ~((0x1ul << (7)) << (u32ChannelNum << 3UL));
    }
    else
    {
        (pwm)->EADCTS1 &= ~((0x1ul << (7)) << ((u32ChannelNum - 4UL) << 3UL));
    }
}
# 364 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearADCTriggerFlag(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    (pwm)->STATUS = ((0x1ul << (16)) << u32ChannelNum);
}
# 379 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetADCTriggerFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->STATUS & ((0x1ul << (16)) << u32ChannelNum)) ? 1UL : 0UL);
}
# 410 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableFaultBrake(PWM_T *pwm, uint32_t u32ChannelMask, uint32_t u32LevelMask, uint32_t u32BrakeSource)
{
    uint32_t i;
    ...
    for (i = 0UL; i < (6UL); i ++)
    {
        if (u32ChannelMask & (1UL << i))
        {
            if ((u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (0)))) || (u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (1)))) || (u32BrakeSource == ((0x1ul << (7)) | (0x1ul << (3)))) || (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (0)))) || (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (1)))) || (u32BrakeSource == ((0x1ul << (15)) | (0x1ul << (3)))))



            {
                (pwm)->BRKCTL[i >> 1UL] |= (u32BrakeSource & ((0x1ul << (7)) | (0x1ul << (15))));
        ...
        if (u32LevelMask & (1UL << i))
        {
            if ((i & 0x1UL) == 0UL)
            {
                ...
                (pwm)->BRKCTL[i >> 1UL] &= ~(0x3ul << (16));
                (pwm)->BRKCTL[i >> 1UL] |= ((3UL) << (16));
            }
            else
            {

                (pwm)->BRKCTL[i >> 1UL] &= ~(0x3ul << (18));
                (pwm)->BRKCTL[i >> 1UL] |= ((3UL) << (18));
            }
        }
        else
        {
            if ((i & 0x1UL) == 0UL)
            {
                ...
                (pwm)->BRKCTL[i >> 1UL] &= ~(0x3ul << (16));
                (pwm)->BRKCTL[i >> 1UL] |= ((2UL) << (16));
            }
            else
            {

                (pwm)->BRKCTL[i >> 1UL] &= ~(0x3ul << (18));
                (pwm)->BRKCTL[i >> 1UL] |= ((2UL) << (18));
            }
        }
    }

}
# 475 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableCapture(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->CAPINEN |= u32ChannelMask;
    (pwm)->CAPCTL |= u32ChannelMask;
}
# 490 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableCapture(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->CAPINEN &= ~u32ChannelMask;
    (pwm)->CAPCTL &= ~u32ChannelMask;
}
# 505 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableOutput(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->POEN |= u32ChannelMask;
}
# 519 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableOutput(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->POEN &= ~u32ChannelMask;
}
# 535 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableDeadZone(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{

    (pwm)->DTCTL[(u32ChannelNum) >> 1UL] &= ~(0xffful << (0));
    (pwm)->DTCTL[(u32ChannelNum) >> 1UL] |= (0x1ul << (16)) | u32Duration;
}
# 551 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableDeadZone(PWM_T *pwm, uint32_t u32ChannelNum)
{

    (pwm)->DTCTL[(u32ChannelNum) >> 1UL] &= ~(0x1ul << (16));
}
# 568 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableCaptureInt(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (pwm)->CAPIEN |= (u32Edge << u32ChannelNum);
}
# 584 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableCaptureInt(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (pwm)->CAPIEN &= ~(u32Edge << u32ChannelNum);
}
# 600 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearCaptureIntFlag(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (pwm)->CAPIF = (u32Edge << u32ChannelNum);
}
# 617 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetCaptureIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    uint32_t u32CapFFlag, u32CapRFlag ;
    u32CapFFlag = (((pwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1UL : 0UL) ;
    u32CapRFlag = (((pwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL) ;
    return ((u32CapFFlag << 1UL) | u32CapRFlag);
}
# 635 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableDutyInt(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32IntDutyType)
{
    (pwm)->INTEN0 |= (u32IntDutyType << u32ChannelNum);
}
# 648 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableDutyInt(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTEN0 &= ~((((0x1ul << (24))) | ((0x1ul << (16)))) << u32ChannelNum);
}
# 661 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearDutyIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTSTS0 = ((0x1ul << (16)) | (0x1ul << (24))) << u32ChannelNum;
}
# 677 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetDutyIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return ((((pwm)->INTSTS0 & (((0x1ul << (24)) | (0x1ul << (16))) << u32ChannelNum))) ? 1 : 0);
}
# 693 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableLoadMode(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32LoadMode)
{
    (pwm)->CTL0 |= (u32LoadMode << u32ChannelNum);
}
# 709 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableLoadMode(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32LoadMode)
{
    (pwm)->CTL0 &= ~(u32LoadMode << u32ChannelNum);
}
# 724 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableFaultBrakeInt(PWM_T *pwm, uint32_t u32BrakeSource)
{
    (pwm)->INTEN1 |= (0x7UL << u32BrakeSource);
}
# 739 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableFaultBrakeInt(PWM_T *pwm, uint32_t u32BrakeSource)
{
    (pwm)->INTEN1 &= ~(0x7UL << u32BrakeSource);
}
# 753 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearFaultBrakeIntFlag(PWM_T *pwm, uint32_t u32BrakeSource)
{
    (pwm)->INTSTS1 = (0x3fUL << u32BrakeSource);
}
# 769 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetFaultBrakeIntFlag(PWM_T *pwm, uint32_t u32BrakeSource)
{
    return (((pwm)->INTSTS1 & (0x3fUL << u32BrakeSource)) ? 1UL : 0UL);
}
# 783 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnablePeriodInt(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32IntPeriodType)
{
    (pwm)->INTEN0 |= ((0x1ul << (8)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 796 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisablePeriodInt(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTEN0 &= ~((0x1ul << (8)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 809 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearPeriodIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTSTS0 = ((0x1ul << (8)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 825 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetPeriodIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->INTSTS0 & ((0x1ul << (8)) << ((u32ChannelNum >> 1UL) << 1UL))) ? 1UL : 0UL);
}
# 838 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableZeroInt(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTEN0 |= ((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 851 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableZeroInt(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTEN0 &= ~((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 864 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearZeroIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->INTSTS0 = ((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 880 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetZeroIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->INTSTS0 & ((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL))) ? 1UL : 0UL);
}
# 900 "../../../../Library/StdDriver/src/pwm.c"
void PWM_SetClockSource(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32ClkSrcSel)
{
    (pwm)->CLKSRC = ((pwm)->CLKSRC & ~((0x7ul << (0)) << ((u32ChannelNum >> 1UL) * (8)))) | (u32ClkSrcSel << ((u32ChannelNum >> 1UL) * (8)));

}
# 924 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableBrakeNoiseFilter(PWM_T *pwm, uint32_t u32BrakePinNum, uint32_t u32ClkCnt, uint32_t u32ClkDivSel)
{
    (pwm)->BNF = ((pwm)->BNF & ~(((0x7ul << (4)) | (0x7ul << (1))) << (u32BrakePinNum * (8)))) | (((u32ClkCnt << (4)) | (u32ClkDivSel << (1)) | (0x1ul << (0))) << (u32BrakePinNum * (8)));

}
# 938 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableBrakeNoiseFilter(PWM_T *pwm, uint32_t u32BrakePinNum)
{
    (pwm)->BNF &= ~((0x1ul << (0)) << (u32BrakePinNum * (8)));
}
# 951 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnableBrakePinInverse(PWM_T *pwm, uint32_t u32BrakePinNum)
{
    (pwm)->BNF |= ((0x1ul << (7)) << (u32BrakePinNum * (8)));
}
# 964 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisableBrakePinInverse(PWM_T *pwm, uint32_t u32BrakePinNum)
{
    (pwm)->BNF &= ~((0x1ul << (7)) << (u32BrakePinNum * (8)));
}
# 978 "../../../../Library/StdDriver/src/pwm.c"
void PWM_SetBrakePinSource(PWM_T *pwm, uint32_t u32BrakePinNum, uint32_t u32SelAnotherModule)
{
    (pwm)->BNF = ((pwm)->BNF & ~((0x1ul << (16)) << (u32BrakePinNum << 3UL))) | (u32SelAnotherModule << ((16) + (u32BrakePinNum << 3UL)));
}
# 994 "../../../../Library/StdDriver/src/pwm.c"
uint32_t PWM_GetWrapAroundFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    return (((pwm)->STATUS & ((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL))) ? 1UL : 0UL);
}
# 1007 "../../../../Library/StdDriver/src/pwm.c"
void PWM_ClearWrapAroundFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->STATUS = ((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 1UL));
}
# 1026 "../../../../Library/StdDriver/src/pwm.c"
void PWM_EnablePDMA(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32RisingFirst, uint32_t u32Mode)
{
    uint32_t u32IsOddCh;
    u32IsOddCh = u32ChannelNum % 2UL;
    (pwm)->PDMACTL = ((pwm)->PDMACTL & ~(((0x1ul << (4)) | (0x1ul << (3)) | (0x3ul << (1))) << ((u32ChannelNum >> 1UL) << 3UL))) | (((u32IsOddCh << (4)) | (u32RisingFirst << (3)) | u32Mode | (0x1ul << (0))) << ((u32ChannelNum >> 1UL) << 3UL));


}
# 1043 "../../../../Library/StdDriver/src/pwm.c"
void PWM_DisablePDMA(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->PDMACTL &= ~((0x1ul << (0)) << ((u32ChannelNum >> 1UL) << 3UL));
}
