# 1 "../../../../Library/StdDriver/src/tk.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/tk.c" 2
...
# 10 "../../../../Library/StdDriver/src/tk.c" 2
# 31 "../../../../Library/StdDriver/src/tk.c"
void TK_Open(void)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC |= (0x1ul << (31));


    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->IDLSC = 0;
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL = 0;

    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0x01925000) == 0x01925000)
    {

        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->IDLSC1 = 0;
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL1 = 0;
    }

    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC &= ~((0x3ul << (0)) | (0x3ul << (2)));
}
...
# 70 "../../../../Library/StdDriver/src/tk.c"
void TK_SetScanMode(uint32_t u32Mode)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC &= ~(0x1ul << (25));
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC &= ~(0x1ul << (23));

    if (u32Mode == ((0x1ul << (25))))
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC |= u32Mode;
    }
    else if (u32Mode == ((0x1ul << (23))))
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC |= u32Mode;
    }
    else if (u32Mode == ((0x1ul << (25)) | (0x1ul << (23))))
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC |= (0x1ul << (25));
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC |= (0x1ul << (23));
    }
}
# 120 "../../../../Library/StdDriver/src/tk.c"
void TK_ConfigSensitivity(uint32_t u32PulseWidth, uint32_t u32SenseCnt, uint32_t u32AVCCHSel)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC & ~((0x7ul << (24)) | (0x7ul << (28)))) | (u32PulseWidth | u32SenseCnt);
    (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC & ~(0xful << (20))) | (u32AVCCHSel));
}
# 135 "../../../../Library/StdDriver/src/tk.c"
void TK_SetCapBankPol(uint32_t u32CapBankPolSel)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC & ~(0x3ul << (4))) | (u32CapBankPolSel << (4));
}
# 150 "../../../../Library/StdDriver/src/tk.c"
void TK_SetTkPol(uint32_t u32Mask, uint32_t u32PolSel)
{
    uint32_t i;

    if ((1ul << 16) & u32Mask)
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC & ~(0x3ul << (2))) | (u32PolSel << (2));

    for (i = 0 ; i < 16 ; i++)
    {
        if ((1ul << i) & u32Mask)
            ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL & ~((0x3ul << (0)) << (i * 2))) | (u32PolSel << (i * 2));
    }

    for (i = 17 ; i < 26 ; i++)
    {
        if ((1ul << i) & u32Mask)
            ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL1 = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLSEL1 & ~((0x3ul << (0)) << ((i - 17) * 2))) | (u32PolSel << ((i - 17) * 2));
    }
}
# 177 "../../../../Library/StdDriver/src/tk.c"
void TK_EnableTkPolarity(uint32_t u32Mask)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC |= ((u32Mask & 0x1FFFF) << (8));

    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0x01925000) == 0x01925000)
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC1 |= (u32Mask >> 17);
    }
}
# 194 "../../../../Library/StdDriver/src/tk.c"
void TK_DisableTkPolarity(uint32_t u32Mask)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->POLC &= ~((u32Mask & 0x1FFFF) << (8));
...
# 211 "../../../../Library/StdDriver/src/tk.c"
void TK_SetCompCapBankData(uint32_t u32TKNum, uint32_t u32CapData)
{
    if (u32TKNum <= 16)
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD0) + ((u32TKNum % 17) >> 2)) &= ~((0xfful << (0)) << ((u32TKNum % 17) % 4 * 8));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD0) + ((u32TKNum % 17) >> 2)) |= (u32CapData << ((u32TKNum % 17) % 4 * 8));
    }
    else
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD5) + ((u32TKNum % 17) >> 2)) &= ~((0xfful << (0)) << ((u32TKNum % 17) % 4 * 8));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD5) + ((u32TKNum % 17) >> 2)) |= (u32CapData << ((u32TKNum % 17) % 4 * 8));
    }
}
...
void TK_SetRefKeyCapBankData(uint32_t u32CapData)
{
    ...
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD4 = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD4 & ~(0xfful << (8))) | (u32CapData << (8));
}
# 244 "../../../../Library/StdDriver/src/tk.c"
void TK_SetRefCapBankData(uint32_t u32TKNum, uint32_t u32CapData)
{
    if (u32TKNum <= 16)
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD0) + ((u32TKNum % 17) >> 2)) &= ~((0xfful << (0)) << ((u32TKNum % 17) % 4 * 8));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD0) + ((u32TKNum % 17) >> 2)) |= (u32CapData << ((u32TKNum % 17) % 4 * 8));
    }
    else
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD5) + ((u32TKNum % 17) >> 2)) &= ~((0xfful << (0)) << ((u32TKNum % 17) % 4 * 8));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD5) + ((u32TKNum % 17) >> 2)) |= (u32CapData << ((u32TKNum % 17) % 4 * 8));
    }
}
# 265 "../../../../Library/StdDriver/src/tk.c"
void TK_SetScanThreshold(uint32_t u32TKNum, uint32_t u32HighLevel)
{
    if (u32TKNum <= 16)
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC01) + ((u32TKNum % 17) >> 1)) &= ~(((0xfful << (8))) << (((u32TKNum % 17) & 0x1) * 16));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC01) + ((u32TKNum % 17) >> 1)) |= (u32HighLevel << ((8) + ((u32TKNum % 17) & 0x1) * 16));
    }
    else
    {
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC1718) + ((u32TKNum % 17) >> 1)) &= ~(((0xfful << (8))) << (((u32TKNum % 17) & 0x1) * 16));
        *(volatile uint32_t *)(&(((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC1718) + ((u32TKNum % 17) >> 1)) |= (u32HighLevel << ((8) + ((u32TKNum % 17) & 0x1) * 16));
    }
}
# 288 "../../../../Library/StdDriver/src/tk.c"
void TK_EnableInt(uint32_t u32Msk)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->INTEN |= u32Msk;
}
# 302 "../../../../Library/StdDriver/src/tk.c"
void TK_DisableInt(uint32_t u32Msk)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->INTEN &= ~u32Msk;
}
...
void TK_DisableAllChannel(void)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC &= ~(0x1FFFF);

    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0x01925000) == 0x01925000)
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->SCANC1 &= ~(0x1F);
    }
}
...
void TK_ClearTKIF(void)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->STA |= 0x1FFFFC3UL;

    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0x01925000) == 0x01925000)
    {
        ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->STA1 |= 0x1FUL;
    }
}
# 346 "../../../../Library/StdDriver/src/tk.c"
void TK_EnableScanAll(uint8_t u8RefcbAll, uint8_t u8CcbAll, uint8_t u8HThAll)
{
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->REFC |= (0x1ul << (23));
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD4 = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->TK_REFCBD4 & (~(0xfful << (8)))) | (u8RefcbAll << (8));
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD4 = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->CCBD4 & (~(0xfful << (8)))) | (u8CcbAll << (8));
    ((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC16 = (((TK_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x82000UL))->THC16 & (~(0xfful << (24)))) | (u8HThAll << (24));
}
