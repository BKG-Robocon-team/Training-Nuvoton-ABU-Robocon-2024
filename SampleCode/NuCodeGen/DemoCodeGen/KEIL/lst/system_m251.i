# 1 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c" 2
# 10 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
...
cmse_check_address_range(void *__pb, size_t __s, int __flags) {
  ...
  case 4:
    ...
    break;
# 158 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\arm_cmse.h" 3
  default:
    return 0;
  }
  ...
  switch (__flags & ~(4 | 16)) {
# 184 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\arm_cmse.h" 3
  case 8 | 1:
  case 1:
...
# 11 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c" 2
...
# 12 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c" 2
...
# 14 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c" 2
...
uint32_t CyclesPerUs = ((48000000UL) / 1000000);
uint32_t PllClock = (48000000UL);
const uint32_t gau32ClkSrcTbl[8] = {12000000ul, 32768ul, 0UL, (38400UL), 0UL, (4032000UL), 0UL, (48000000UL)};
# 37 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
void SystemCoreClockUpdate(void)
{
    uint32_t u32Freq, u32ClkSrc;
    uint32_t u32HclkDiv;

    u32ClkSrc = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 & (0x7ul << (0));


    PllClock = CLK_GetPLLClockFreq();

    if (u32ClkSrc != (0x02UL<<(0)))
    {
    ...
    u32HclkDiv = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (0xful << (0))) + 1;
...
# 73 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
void SystemInit(void)
{

    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->CYCCTL = (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->CYCCTL & ~(0xful << (0))) | (3 << (0)) | 0x100;


    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (uint32_t) &__Vectors;
# 92 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
}
# 124 "../../../../Library/Device/Nuvoton/M251/Source/system_M251.c"
    __attribute__((weak))
...
void Uart0DefaultMPF(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPH = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPH & ~(0xful << (16))) | (0x06UL<<(16));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPH = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPH & ~(0xful << (20))) | (0x06UL<<(20));
