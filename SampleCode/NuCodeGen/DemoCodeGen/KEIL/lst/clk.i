...
# 30 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableCKO(void)
{

    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->APBCLK0 &= (~(0x1ul << (6)));
}
# 57 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (~(0x7ul << (4)))) | (u32ClkSrc);
}
# 76 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_PowerDown(void)
{
    uint32_t u32HIRCTRIMCTL, u32MIRCTRIMCTL;


    if ((!(((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL & (0x1ul << (3)))) && ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (3)))))
    {
        return 0UL;
    }
    ...
    u32HIRCTRIMCTL = ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL;
    u32MIRCTRIMCTL = ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->MIRCTRIMCTL;


    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL &= (~(0x3ul << (0)));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->MIRCTRIMCTL &= (~(0x3ul << (0)));


    __builtin_arm_wfi();


    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL = u32HIRCTRIMCTL;
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->MIRCTRIMCTL = u32MIRCTRIMCTL;
...
uint32_t CLK_GetHXTFreq(void)
{
    if (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL & (0x1ul << (0)))
        return 12000000ul;
    else
        return 0UL;
}
...
uint32_t CLK_GetLXTFreq(void)
{
    if (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL & (0x1ul << (1)))
        return 32768ul;
    else
        return 0UL;
}
...
uint32_t CLK_GetPCLK0Freq(void)
{
    ...
    switch (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (0)))
    {
        case ((0x0UL<<(0))):
...
uint32_t CLK_GetPCLK1Freq(void)
{
    ...
    switch (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (4)))
    {
        case ((0x0UL<<(4))):
            return SystemCoreClock;
...
# 251 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPLLClockFreq(void)
{
    uint32_t u32PllFreq;
    uint32_t u32Reg;
    ...
    u32PllFreq = 0UL;
    u32Reg = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL;
    ...
    if ((u32Reg & ((0x1ul << (16)) | (0x1ul << (18)))) == 0)
    {
        ...
        else
        {
            ...
            const uint8_t au8NoTbl[4] = {1u, 2u, 4u, 4u};


            u32NO = au8NoTbl[((u32Reg & (0x3ul << (14))) >> (14))];
            u32NF = ((u32Reg & (0x3ful << (0))) >> (0));
            u32NR = ((u32Reg & (0xful << (9))) >> (9));
...
void CLK_DisablePLL(void)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 318 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if (u32PllClkSrc == (0x0ul << (19)))
    {

        ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL & ~(0x1ul << (0))) | (0x1ul << (0));
    ...
    else if (u32PllClkSrc == (0x1ul << (19)))
    {

        ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL |= (0x1ul << (2));

        ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL |= (0x1ul << (19));


        CLK_WaitClockReady((0x1ul << (4)));

        CLK_WaitClockReady((0x1ul << (6)));


        u32ClkSrc = (0x1ul << (19));
        u32PllSrcClk = ((48000000UL) >> 2);
    }
    else
    {
        ...
        u32ClkSrc = (0x3ul << (19));
        u32PllSrcClk = (4032000UL);
    }

    if ((u32PllFreq <= 100000000UL) && (u32PllFreq >= 16000000UL))
    {
        ...
        for (u32NO = 0UL; u32NO <= 3UL; u32NO++)
        {
            ...
            if (u32NO != 2UL)
            {
                ...
                for (u32NR = 1UL; u32NR <= 6UL; u32NR++)
                {
                    u32Tmp = u32PllSrcClk / u32NR;

                    if (u32Tmp >= 4000000UL && u32Tmp <= 8000000UL)
                    {
                        for (u32NF = 8UL; u32NF <= 25UL; u32NF++)
                        {
                            u32Tmp2 = u32Tmp * u32NF;

                            if ((u32Tmp2 >= 64000000UL) && (u32Tmp2 <= 100000000UL))
                            {
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = u32ClkSrc | (u32MinNO << 14) | ((u32MinNR) << 9) | (u32MinNF);
...
lexit:
    ...
    if (u32PllFreq < 16000000UL)
    {
        if (u32PllClkSrc == (0x0ul << (19)))
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x0ul << (19)) | ((3)<<(9)) | (16) | 0xC000UL);
        else if (u32PllClkSrc == (0x1ul << (19)))
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x1ul << (19)) | ((3)<<(9)) | (16) | 0xC000UL);
        else
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x3ul << (19)) | ((1)<<(9)) | (16) | 0xC000UL);
    }
    else
    {
        if (u32PllClkSrc == (0x0ul << (19)))
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x0ul << (19)) | ((3)<<(9)) | (25) | 0x0000UL);
        else if (u32PllClkSrc == (0x1ul << (19)))
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x1ul << (19)) | ((3)<<(9)) | (25) | 0x0000UL);
        else
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL = ((0x3ul << (19)) | ((1)<<(9)) | (25) | 0x0000UL);
    }
...
# 505 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HircStable;


    u32HircStable = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (4));


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x07UL<<(0));
...
# 540 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    uint32_t u32PllclkSet;


    if (u32Hclk > 48000000UL)
        u32Hclk = 48000000UL;

    if (u32Hclk < 25000000UL)
        u32Hclk = 25000000UL;


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL |= (0x1ul << (19));
    CLK_WaitClockReady((0x1ul << (6)));
    CLK_SetHCLK((0x05UL<<(0)), (((1)-1) << (0)));

    u32PllclkSet = (u32Hclk << 1);


    if (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (0)))
        u32PllclkSet = CLK_EnablePLL((0x0ul << (19)), u32PllclkSet);


    else if ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (6))) && (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (4))))
    {
        u32PllclkSet = CLK_EnablePLL((0x1ul << (19)), u32PllclkSet);
    }
    else
        return 0UL;
    ...
    CLK_SetHCLK((0x02UL<<(0)), (((2)-1) << (0)));
    return (u32PllclkSet >> 1);
}
# 687 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    if ((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32Div = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 + (au32DivTbl[(((u32ModuleIdx) >>18) & 0x3)]);
    ...
    if ((((u32ModuleIdx) >>25) & 0x7) != 0x0)
    {
        ...
        u32Sel = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 + (au32SelTbl[(((u32ModuleIdx) >>28) & 0x3)]);

        (*((vu32 *) (u32Sel))) = ((*((vu32 *) (u32Sel))) & (~((((u32ModuleIdx) >>25) & 0x7) << (((u32ModuleIdx) >>20) & 0x1f)))) | u32ClkSrc;
    }
}
# 723 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 & ~(0x7ul << (3))) | u32ClkSrc;
}
# 744 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL |= u32ClkMask;
}
# 760 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL &= ~u32ClkMask;
}
# 817 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    const uint32_t au32ClkTbl[3] = {0x0UL, 0x4UL, 0x8UL};

    *(volatile uint32_t *)((uint32_t)&((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->AHBCLK + (au32ClkTbl[(((u32ModuleIdx) >>30) & 0x3)])) |= 1 << (((u32ModuleIdx) >>0 ) & 0x1f);
}
# 876 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    const uint32_t au32ClkTbl[3] = {0x0UL, 0x4UL, 0x8UL};
...
# 897 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
    ...
    while (!(((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & u32ClkMask))
    {
        if (--u32TimeOutCnt == 0)
        {
            g_CLK_i32ErrCode = (-1);
...
# 929 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockDisable(uint32_t u32ClkMask)
{
    uint32_t u32TimeOutCnt = SystemCoreClock;
...
# 960 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
    ...
    if (u32ClkSrc == (0x01UL<<2U))
    {
        ...
        ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->AHBCLK &= ~(0x1ul << (4));
...
# 1016 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetPowerDownMode(uint32_t u32PDMode)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x7ul << (0)))) | u32PDMode;
}
# 1039 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin(uint32_t u32Pin, uint32_t u32TriggerType)
{
    switch (u32Pin)
    {
        case (0x0UL):
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (16)))) | (u32TriggerType << (16));
            break;

        case (0x1UL):
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (24)))) | (u32TriggerType << (24));
            break;

        case (0x2UL):
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (26)))) | (u32TriggerType << (26));
            break;

        case (0x3UL):
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (28)))) | (u32TriggerType << (28));
            break;

        case (0x4UL):
            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (30)))) | (u32TriggerType << (30));
            break;
    }
}
# 1076 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin0(uint32_t u32TriggerType)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (16)))) | u32TriggerType;
}
# 1092 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin1(uint32_t u32TriggerType)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (24)))) | u32TriggerType;
}
# 1108 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin2(uint32_t u32TriggerType)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (26)))) | u32TriggerType;
}
# 1124 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin3(uint32_t u32TriggerType)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (28)))) | u32TriggerType;
}
# 1140 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin4(uint32_t u32TriggerType)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUCTL & ~((0x3ul << (30)))) | u32TriggerType;
}
# 1153 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPMUWKSrc(void)
{
    return (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PMUSTS);
}
# 1187 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL;


    if (u32ModuleIdx == ((((2) & 0x03) << 30)|((((16)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)))
    {
        u32TmpVal = ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (0))) >> (0));
    }
    else if (u32ModuleIdx == ((((2) & 0x03) << 30)|((((17)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((1) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)))
    {
        u32TmpVal = ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (1))) >> (1));
    }
    else if (u32ModuleIdx == ((((2) & 0x03) << 30)|((((18)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((8) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)))
    {
        u32TmpVal = ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (8))) >> (8));
    }
    else if (u32ModuleIdx == ((((2) & 0x03) << 30)|((((19)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((9) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)))
    {
        u32TmpVal = ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (9))) >> (9));
    }
    else if ((((u32ModuleIdx) >>25) & 0x7) != 0x0)
    {
        uint32_t u32TmpAddr;
        const uint32_t au32SelTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0xCUL};


        u32TmpAddr = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 + (au32SelTbl[(((u32ModuleIdx) >>28) & 0x3)]);


        u32TmpVal = ((((*((volatile unsigned int *)((uint32_t *)u32TmpAddr)))) & ((((u32ModuleIdx) >>25) & 0x7) << (((u32ModuleIdx) >>20) & 0x1f))) >> (((u32ModuleIdx) >>20) & 0x1f));
    }

    return u32TmpVal;
}
# 1237 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL;
    ...
    if ((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32TmpAddr = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 + (au32DivTbl[(((u32ModuleIdx) >>18) & 0x3)]);

        u32TmpVal = ((((*((volatile unsigned int *)((uint32_t *)u32TmpAddr)))) & ((((u32ModuleIdx) >>10) & 0xff) << (((u32ModuleIdx) >>5 ) & 0x1f))) >> (((u32ModuleIdx) >>5 ) & 0x1f));
    }
