...
static void delay(uint32_t t){
   TIMER_Delay(((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL)), t);
}
...
int32_t main(void)
{
  ...
  System_Init();
  Write_Data_Modbus(1, CTRL_CMD, 0x05);
  Write_Data_Modbus(1, ACC_ADDR, 1);
  Write_Data_Modbus(1, DEC_ADDR, 1);
  delay(1);
  Write_Data_Modbus(2, CTRL_CMD, 0x05);
  Write_Data_Modbus(2, ACC_ADDR, 1);
  Write_Data_Modbus(2, DEC_ADDR, 1);
  delay(1);
  Write_Data_Modbus(3, CTRL_CMD, 0x05);
  Write_Data_Modbus(3, ACC_ADDR, 1);
  Write_Data_Modbus(3, DEC_ADDR, 1);
  delay(1000);
  WitInit(0, 0x50);
...
# 87 "../main.c"
 while (1)
 {
            TIMER_Delay(((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL)), 10000000);
 }
}
