# 1 "../../../../Library/StdDriver/src/qspi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/qspi.c" 2
...
# 10 "../../../../Library/StdDriver/src/qspi.c" 2
# 43 "../../../../Library/StdDriver/src/qspi.c"
                   ...
                   uint32_t u32BusClock)
{
    ...
    if (u32MasterSlave == (0x0UL))
    {
        ...
        qspi->CTL = u32MasterSlave | (u32DataWidth << (8)) | (u32QSPIMode) | (0x1ul << (0));

        if (u32BusClock >= u32HCLKFreq)
        {

            ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (~(0x3ul << (2)))) | (0x2UL<<(2));
        }


        if ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x3ul << (2))) == (0x0UL<<(2)))
        {
            u32ClkSrc = 12000000ul;
        }
        else if ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x3ul << (2))) == (0x1UL<<(2)))
        {
            u32ClkSrc = CLK_GetPLLClockFreq();
        }
        else if ((((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x3ul << (2))) == (0x2UL<<(2)))
        {
        ...
        else
        {
            ...
            {
                qspi->CLKDIV = (qspi->CLKDIV & (~(0x1fful << (0)))) | (u32Div << (0));
...
void QSPI_Close(QSPI_T *qspi)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST1 |= (0x1ul << (12));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST1 &= ~(0x1ul << (12));
}
...
void QSPI_DisableAutoSS(QSPI_T *qspi)
{
    qspi->SSCTL &= ~((0x1ul << (3)) | (0x1ul << (0)));
}
# 203 "../../../../Library/StdDriver/src/qspi.c"
void QSPI_EnableAutoSS(QSPI_T *qspi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    qspi->SSCTL = (qspi->SSCTL & (~((0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (0))))) | (u32SSPinMask | u32ActiveLevel | (0x1ul << (3)));
}
# 220 "../../../../Library/StdDriver/src/qspi.c"
uint32_t QSPI_SetBusClock(QSPI_T *qspi, uint32_t u32BusClock)
{
...
# 303 "../../../../Library/StdDriver/src/qspi.c"
void QSPI_SetFIFO(QSPI_T *qspi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    qspi->FIFOCTL = (qspi->FIFOCTL & ~((0x7ul << (28)) | (0x7ul << (24)))) |
                    (u32TxThreshold << (28)) |
                    (u32RxThreshold << (24));
}
...
uint32_t QSPI_GetBusClock(QSPI_T *qspi)
{
    ...
    u32Div = (qspi->CLKDIV & (0x1fful << (0))) >> (0);
...
# 367 "../../../../Library/StdDriver/src/qspi.c"
void QSPI_EnableInt(QSPI_T *qspi, uint32_t u32Mask)
{
    ...
    {
        qspi->FIFOCTL |= (0x1ul << (7));
    }


    if ((u32Mask & (0x080UL)) == (0x080UL))
    {
        qspi->FIFOCTL |= (0x1ul << (3));
    }


    if ((u32Mask & (0x100UL)) == (0x100UL))
    {
        qspi->FIFOCTL |= (0x1ul << (2));
    }


    if ((u32Mask & (0x200UL)) == (0x200UL))
    {
        qspi->FIFOCTL |= (0x1ul << (5));
    }


    if ((u32Mask & (0x400UL)) == (0x400UL))
    {
        qspi->FIFOCTL |= (0x1ul << (4));
    }
}
# 456 "../../../../Library/StdDriver/src/qspi.c"
void QSPI_DisableInt(QSPI_T *qspi, uint32_t u32Mask)
{
...
# 546 "../../../../Library/StdDriver/src/qspi.c"
uint32_t QSPI_GetIntFlag(QSPI_T *qspi, uint32_t u32Mask)
{
    uint32_t u32IntFlag = 0U, u32TmpVal;

    u32TmpVal = qspi->STATUS & (0x1ul << (1));
    ...
    u32TmpVal = qspi->STATUS & (0x1ul << (5));


    if ((u32Mask & (0x020UL)) && (u32TmpVal))
    {
        u32IntFlag |= (0x020UL);
    }

    u32TmpVal = qspi->STATUS & (0x1ul << (19));
    ...
    u32TmpVal = qspi->STATUS & (0x1ul << (18));
    ...
    u32TmpVal = qspi->STATUS & (0x1ul << (10));
    ...
    u32TmpVal = qspi->STATUS & (0x1ul << (11));
    ...
    u32TmpVal = qspi->STATUS & (0x1ul << (12));
...
# 659 "../../../../Library/StdDriver/src/qspi.c"
void QSPI_ClearIntFlag(QSPI_T *qspi, uint32_t u32Mask)
{
    if (u32Mask & (0x001UL))
    {
    ...
    if (u32Mask & (0x040UL))
    {
        qspi->STATUS = (0x1ul << (19));
    }

    if (u32Mask & (0x200UL))
    {
        qspi->STATUS = (0x1ul << (11));
    }

    if (u32Mask & (0x400UL))
    {
        qspi->STATUS = (0x1ul << (12));
    }
}
# 725 "../../../../Library/StdDriver/src/qspi.c"
uint32_t QSPI_GetStatus(QSPI_T *qspi, uint32_t u32Mask)
{
    uint32_t u32Flag = 0UL, u32TmpValue;

    u32TmpValue = qspi->STATUS & (0x1ul << (0));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (8));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (9));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (16));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (17));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (23));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (15));
    ...
    u32TmpValue = qspi->STATUS & (0x1ul << (4));
