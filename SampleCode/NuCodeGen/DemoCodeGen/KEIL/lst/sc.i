# 1 "../../../../Library/StdDriver/src/sc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/sc.c" 2
...
# 10 "../../../../Library/StdDriver/src/sc.c" 2



static uint32_t u32CardStateIgnore[(1ul)] = {0UL};
# 39 "../../../../Library/StdDriver/src/sc.c"
uint32_t SC_IsCardInserted(SC_T *psSC)
{
    uint32_t ret;


    uint32_t cond1 = ((psSC->STATUS & (0x1ul << (13))) >> (13));
    uint32_t cond2 = ((psSC->CTL & (0x1ul << (26))) >> (26));

    if ((psSC == ((SC_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x50000UL))) && (u32CardStateIgnore[0] == 1UL))
    {
        ret = (uint32_t)(1UL);
    }
    else if (cond1 != cond2)
...
# 71 "../../../../Library/StdDriver/src/sc.c"
void SC_ClearFIFO(SC_T *psSC)
{
    while (psSC->ALTCTL & (0x1ul << (31)))
    {
        ;
    }

    psSC->ALTCTL |= ((0x1ul << (0)) | (0x1ul << (1)));
}
# 89 "../../../../Library/StdDriver/src/sc.c"
void SC_Close(SC_T *psSC)
{
    psSC->INTEN = 0UL;

    while (psSC->PINCTL & (0x1ul << (30)))
    {
        ;
    }
...
# 124 "../../../../Library/StdDriver/src/sc.c"
void SC_Open(SC_T *psSC, uint32_t u32CardDet, uint32_t u32PWR)
{
    uint32_t u32Reg = 0UL, u32Intf;

    if (psSC == ((SC_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x50000UL)))
    {
        u32Intf = 0UL;
    }
    else
    ...
    if (u32CardDet != (0xFFFFFFFFul))
    {
        u32Reg = u32CardDet ? 0UL : (0x1ul << (26));
    ...
    psSC->PINCTL = u32PWR ? 0UL : (0x1ul << (11));
    ...
    psSC->CTL = (0x1ul << (0)) | u32Reg;
}
# 165 "../../../../Library/StdDriver/src/sc.c"
void SC_ResetReader(SC_T *psSC)
{
    uint32_t u32Intf;
    ...
    psSC->ALTCTL |= ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (11)));
...
# 241 "../../../../Library/StdDriver/src/sc.c"
void SC_SetBlockGuardTime(SC_T *psSC, uint32_t u32BGT)
{
    psSC->CTL = (psSC->CTL & ~(0x1ful << (8))) | ((u32BGT - 1UL) << (8));
}
# 256 "../../../../Library/StdDriver/src/sc.c"
void SC_SetCharGuardTime(SC_T *psSC, uint32_t u32CGT)
{

    u32CGT -= (psSC->CTL & (0x1ul << (15))) ? 11UL : 12UL;
    psSC->EGT = u32CGT;
}
# 272 "../../../../Library/StdDriver/src/sc.c"
void SC_StopAllTimer(SC_T *psSC)
{
    while (psSC->ALTCTL & (0x1ul << (31)))
    {
    ...
    psSC->ALTCTL &= ~((0x1ul << (5)) | (0x1ul << (6)) | (0x1ul << (7)));
}
# 306 "../../../../Library/StdDriver/src/sc.c"
void SC_StartTimer(SC_T *psSC, uint32_t u32TimerNum, uint32_t u32Mode, uint32_t u32ETUCount)
{
    uint32_t reg = u32Mode | ((0xfffffful << (0)) & (u32ETUCount - 1UL));
...
# 366 "../../../../Library/StdDriver/src/sc.c"
void SC_StopTimer(SC_T *psSC, uint32_t u32TimerNum)
{
    while (psSC->ALTCTL & (0x1ul << (31))) {}
...
# 393 "../../../../Library/StdDriver/src/sc.c"
uint32_t SC_GetInterfaceClock(SC_T *psSC)
{
    uint32_t u32ClkSrc, u32Num, u32Clk = (48000000UL), u32Div;


    if (psSC == ((SC_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x50000UL)))
    {
        u32Num = 0UL;
        u32ClkSrc = CLK_GetModuleClockSource(((((2) & 0x03) << 30)|((((0)) & 0x1f) << 0)| (((3) & 0x03) << 28)|(((3) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((1) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((0) & 0x1f) << 5)));
        u32Div = CLK_GetModuleClockDivider(((((2) & 0x03) << 30)|((((0)) & 0x1f) << 0)| (((3) & 0x03) << 28)|(((3) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((1) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((0) & 0x1f) << 5)));
