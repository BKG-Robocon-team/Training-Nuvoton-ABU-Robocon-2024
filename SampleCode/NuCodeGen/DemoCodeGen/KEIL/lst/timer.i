...
# 10 "../../../../Library/StdDriver/src/timer.c" 2
# 42 "../../../../Library/StdDriver/src/timer.c"
uint32_t TIMER_Open(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq)
{
...
# 75 "../../../../Library/StdDriver/src/timer.c"
void TIMER_Close(TIMER_T *timer)
{
    timer->CTL = 0UL;
    timer->EXTCTL = 0UL;
}
# 95 "../../../../Library/StdDriver/src/timer.c"
int32_t TIMER_Delay(TIMER_T *timer, uint32_t u32Usec)
{
    uint32_t u32Clk = TIMER_GetModuleClock(timer);
...
# 194 "../../../../Library/StdDriver/src/timer.c"
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) | (0x7ul << (12)))) |
                    u32CapMode | u32Edge | (0x1ul << (3));
}
# 218 "../../../../Library/StdDriver/src/timer.c"
void TIMER_CaptureSelect(TIMER_T *timer, uint32_t u32Src)
{
    if (u32Src == (0xFFUL))
    {
        timer->CTL = (timer->CTL & ~((0x1ul << (22)))) |
                     ((0UL << (22)));
    }
    else
    {
...
# 242 "../../../../Library/StdDriver/src/timer.c"
void TIMER_DisableCapture(TIMER_T *timer)
{
    timer->EXTCTL &= ~(0x1ul << (3));
}
# 258 "../../../../Library/StdDriver/src/timer.c"
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->TRGCTL = (timer->TRGCTL & ~(0x1ul << (0))) | u32Src;
}
# 277 "../../../../Library/StdDriver/src/timer.c"
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->TRGCTL = (timer->TRGCTL & ~((0x1ul << (1)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (4)) | (0x1ul << (8)))) | u32Mask;
}
# 295 "../../../../Library/StdDriver/src/timer.c"
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~(0x1ul << (0))) | u32Edge;
    timer->CTL |= (0x1ul << (24));
}
# 309 "../../../../Library/StdDriver/src/timer.c"
void TIMER_DisableEventCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (24));
}
# 329 "../../../../Library/StdDriver/src/timer.c"
                             ...
                             uint32_t u32EnableInt)
{
    ...
    if (timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL)))
    {
        ptimerTmp = ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL));
    }
    else if (timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x11000UL)))
    {
        ptimerTmp = ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x11000UL)+ 0x100UL));
    }
    else
    {
        ptimerTmp = (0) ;
    ...
    if (ptimerTmp != (0))
    {
        ...
        ptimerTmp->EXTCTL = u32EnableInt ? (0x1ul << (5)) : 0UL;
        timer->CTL = (0x1ul << (19)) | (0x1ul << (30));
    }
}
# 365 "../../../../Library/StdDriver/src/timer.c"
void TIMER_DisableFreqCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (19));
}
# 380 "../../../../Library/StdDriver/src/timer.c"
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    uint32_t u32Src;
    const uint32_t au32Clk[] = {12000000ul, 32768ul, 0UL, 0UL, 0UL, (38400UL), 0UL, (48000000UL)};

    if (timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL)))
        u32Src = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (8))) >> (8);
    else if (timer == ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)))
        u32Src = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (12))) >> (12);
    else if (timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x11000UL)))
        u32Src = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (16))) >> (16);
    else
        u32Src = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL1 & (0x7ul << (20))) >> (20);

    if (u32Src == 2UL)
    {
        if ((timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL))) || (timer == ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL))))
        {
...
# 420 "../../../../Library/StdDriver/src/timer.c"
int32_t TIMER_ResetCounter(TIMER_T *timer)
{
    uint32_t u32Delay;
    ...
    while (((timer->CNT & (0x1ul << (31))) == (0x1ul << (31))) && (--u32Delay))
    {
        __builtin_arm_nop();
    }
