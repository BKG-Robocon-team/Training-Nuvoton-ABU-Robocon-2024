# 1 "../../../../Library/StdDriver/src/bpwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/bpwm.c" 2
...
# 10 "../../../../Library/StdDriver/src/bpwm.c" 2
# 35 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_ConfigCaptureChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    uint32_t u32Src;
    ...
    if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xff00) == 0x5800 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xff00) == 0x5600 || (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID & 0xff00) == 0x5400)
    {
        if (bpwm == ((BPWM_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x1A000UL)))
        {
            u32Src = (0x1UL<<(8));
        }
        else
    ...
    else
    {
        if (bpwm == ((BPWM_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x1A000UL)))
        {
            u32Src = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (8));
        }
        else
        {
            u32Src = ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x1ul << (9));
        }
    }
    ...
    ((bpwm)->CLKPSC = ((uint32_t)u16Prescale));
...
# 142 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_ConfigOutputChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    uint32_t u32Src;
    uint32_t u32BPWMClockSrc;
    ...
    if (u32DutyCycle)
    {
        if (u32DutyCycle >= 100UL)
            ((bpwm)->CMPDAT[(u32ChannelNum)] = (u16CNR));
        else
            ((bpwm)->CMPDAT[(u32ChannelNum)] = (u32DutyCycle * (u16CNR + 1UL) / 100UL));

        (bpwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (bpwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum << 1UL) + (16)));
        (bpwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (bpwm)->WGCTL1 |= ((2UL) << ((u32ChannelNum << 1UL) + (16)));
    }
    else
    {
        ((bpwm)->CMPDAT[(u32ChannelNum)] = (0UL));
        (bpwm)->WGCTL0 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (bpwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum << 1UL) + (0)));
        (bpwm)->WGCTL1 &= ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1UL));
        (bpwm)->WGCTL1 |= ((2UL) << ((u32ChannelNum << 1UL) + (16)));
    }
...
# 251 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_Start(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->CNTEN = (0x1ul << (0));
}
# 265 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_Stop(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->PERIOD = 0UL;
}
# 279 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ForceStop(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->CNTEN &= ~(0x1ul << (0));
}
# 300 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableADCTrigger(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if (u32ChannelNum < 4UL)
    {
        (bpwm)->EADCTS0 &= ~(((0xful << (0))) << (u32ChannelNum << 3UL));
        (bpwm)->EADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum << 3UL));
    }
    else
    {
        (bpwm)->EADCTS1 &= ~(((0xful << (0))) << ((u32ChannelNum - 4UL) << 3UL));
        (bpwm)->EADCTS1 |= (((0x1ul << (7)) | u32Condition) << ((u32ChannelNum - 4UL) << 3UL));
    }
}
# 322 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableADCTrigger(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    if (u32ChannelNum < 4UL)
    {
        (bpwm)->EADCTS0 &= ~((0x1ul << (7)) << (u32ChannelNum << 3UL));
    }
    else
    {
        (bpwm)->EADCTS1 &= ~((0x1ul << (7)) << ((u32ChannelNum - 4UL) << 3UL));
    }
}
# 343 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearADCTriggerFlag(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    (bpwm)->STATUS = ((0x1ul << (16)) << u32ChannelNum);
}
# 358 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetADCTriggerFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((bpwm)->STATUS & ((0x1ul << (16)) << u32ChannelNum)) ? 1UL : 0UL);
}
# 372 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableCapture(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->CAPINEN |= u32ChannelMask;
    (bpwm)->CAPCTL |= u32ChannelMask;
}
# 387 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableCapture(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->CAPINEN &= ~u32ChannelMask;
    (bpwm)->CAPCTL &= ~u32ChannelMask;
}
# 402 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableOutput(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->POEN |= u32ChannelMask;
}
# 416 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableOutput(BPWM_T *bpwm, uint32_t u32ChannelMask)
{
    (bpwm)->POEN &= ~u32ChannelMask;
}
# 432 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableCaptureInt(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (bpwm)->CAPIEN |= (u32Edge << u32ChannelNum);
}
# 448 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableCaptureInt(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (bpwm)->CAPIEN &= ~(u32Edge << u32ChannelNum);
}
# 464 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearCaptureIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    (bpwm)->CAPIF = (u32Edge << u32ChannelNum);
}
# 481 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetCaptureIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    uint32_t u32CapFFlag, u32CapRFlag ;
    u32CapFFlag = (((bpwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1UL : 0UL) ;
    u32CapRFlag = (((bpwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL) ;
    return ((u32CapFFlag << 1UL) | u32CapRFlag);
}
# 500 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableDutyInt(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32IntDutyType)
{
    (bpwm)->INTEN |= (u32IntDutyType << u32ChannelNum);
}
# 513 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableDutyInt(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTEN &= ~((uint32_t)(((0x1ul << (24))) | ((0x1ul << (16)))) << u32ChannelNum);
}
# 526 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearDutyIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTSTS = ((0x1ul << (16)) | (0x1ul << (24))) << u32ChannelNum;
}
# 542 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetDutyIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return ((((bpwm)->INTSTS & (((0x1ul << (24)) | (0x1ul << (16))) << u32ChannelNum))) ? 1UL : 0UL);
}
# 557 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnablePeriodInt(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32IntPeriodType)
{
    (bpwm)->INTEN |= (0x1ul << (8));
}
# 571 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisablePeriodInt(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTEN &= ~(0x1ul << (8));
}
# 585 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearPeriodIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTSTS = (0x1ul << (8));
}
# 602 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetPeriodIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((bpwm)->INTSTS & (0x1ul << (8))) ? 1UL : 0UL);
}
# 616 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableZeroInt(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTEN |= (0x1ul << (0));
}
# 630 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableZeroInt(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTEN &= ~(0x1ul << (0));
}
# 644 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearZeroIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTSTS = (0x1ul << (0));
}
# 661 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetZeroIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((bpwm)->INTSTS & (0x1ul << (0))) ? 1UL : 0UL);
}
# 677 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_EnableLoadMode(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32LoadMode)
{
    (bpwm)->CTL0 |= (u32LoadMode << u32ChannelNum);
}
# 693 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_DisableLoadMode(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32LoadMode)
{
    (bpwm)->CTL0 &= ~(u32LoadMode << u32ChannelNum);
}
# 713 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_SetClockSource(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32ClkSrcSel)
{
    (bpwm)->CLKSRC = (u32ClkSrcSel);
}
# 730 "../../../../Library/StdDriver/src/bpwm.c"
uint32_t BPWM_GetWrapAroundFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((bpwm)->STATUS & (0x1ul << (0))) ? 1UL : 0UL);
}
# 744 "../../../../Library/StdDriver/src/bpwm.c"
void BPWM_ClearWrapAroundFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->STATUS = (0x1ul << (0));
}
