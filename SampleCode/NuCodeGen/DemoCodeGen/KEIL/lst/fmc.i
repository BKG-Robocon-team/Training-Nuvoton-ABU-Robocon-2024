# 1 "../../../../Library/StdDriver/src/fmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/fmc.c" 2
...
# 10 "../../../../Library/StdDriver/src/fmc.c" 2
...
# 11 "../../../../Library/StdDriver/src/fmc.c" 2
# 24 "../../../../Library/StdDriver/src/fmc.c"
int32_t g_FMC_i32ErrCode = eFMC_ERRCODE_SUCCESS;
# 39 "../../../../Library/StdDriver/src/fmc.c"
void FMC_SetBootSource(int32_t i32BootSrc)
{
    (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL = (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & ~(0x1ul << (1))) | ((i32BootSrc & 0x1u) << (1)));
}
# 53 "../../../../Library/StdDriver/src/fmc.c"
void FMC_Close(void)
{
    (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL &= ~(0x1ul << (0)));
}
# 69 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_GetBootSource(void)
{
    return ((((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & (0x1ul << (1)))?1:0);
}
# 86 "../../../../Library/StdDriver/src/fmc.c"
void FMC_Open(void)
{
    (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (0)));
}
# 105 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_ReadConfig(uint32_t u32Config[], uint32_t u32Count)
{
    uint32_t i;
    ...
    {
        u32Config[i] = FMC_Read(0x00300000UL + i * 4u);
    }

    return g_FMC_i32ErrCode;
}
# 134 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_WriteConfig(uint32_t u32Config[], uint32_t u32Count)
{
    int32_t ret = 0;
    uint32_t i;
    ...
    for (i = 0u; i < u32Count; i++)
    {
        FMC_Write(0x00300000UL + i * 4u, u32Config[i]);

        if (FMC_Read(0x00300000UL + i * 4u) != u32Config[i])
        {
            ret = -1;
        }
    }
...
# 168 "../../../../Library/StdDriver/src/fmc.c"
uint32_t FMC_GetChkSum(uint32_t u32addr, uint32_t u32count)
{
    return FMC_GetCheckSum(u32addr, u32count);
}
# 190 "../../../../Library/StdDriver/src/fmc.c"
uint32_t FMC_CheckAllOne(uint32_t u32addr, uint32_t u32count)
{
    int32_t tout;
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS |= (0x1ul << (7));

    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x28UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32addr;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = u32count;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));

    tout = (SystemCoreClock*2);

    while ((tout-- > 0) && (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS & (0x1ul << (0)))) {}
    ...
    do
    {
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x08UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32addr;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
    ...
    } while (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0UL);

    if (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA11FFFFFUL || ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA1100000UL)
    {
        return ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT;
    }
...
# 256 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_Is_XOM_Actived(uint32_t xom_num)
{
    int32_t ret = 0;
    ...
    {
        uint32_t u32act;
        u32act = (((((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->XOMSTS) & 0xful) & (1ul << xom_num)) >> xom_num;
        ret = (int32_t)u32act;
    }

    return ret;
}
# 293 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_Config_XOM(uint32_t xom_num, uint32_t xom_base, uint8_t xom_page)
{
    int32_t tout;
    int32_t ret = 0;
    ...
    if (ret == 0)
    {
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x21UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = 0x00200000UL + (xom_num * 0x10u);
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = xom_base;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));

        tout = ((SystemCoreClock/10)*2);
        ...
        if (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS & (0x1ul << (6)))
        {
            ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS |= (0x1ul << (6));
    ...
    {
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x21UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = 0x00200000UL + (xom_num * 0x10u + 0x04u);
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = xom_page;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
    ...
    {
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x21UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = 0x00200000UL + (xom_num * 0x10u + 0x08u);
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0u;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
...
# 406 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_Erase_XOM(uint32_t xom_num)
{
    ...
    {
        uint32_t u32Addr;
        u32Addr = ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->XOMR0STS0;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x22UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0x55aa03u;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1u;



        tout = ((SystemCoreClock/10)*4);

        while ((tout-- > 0) && ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG) {}
        ...
        if (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & (0x1ul << (6)))
        {
            ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (6));
            g_FMC_i32ErrCode = eFMC_ERRCODE_CMD_FAIL;
            err = -1;
        }
    }
...
# 475 "../../../../Library/StdDriver/src/fmc.c"
int32_t FMC_Erase(uint32_t u32Addr)
{
    int32_t ret = 0;
    int32_t tout;
...
# 523 "../../../../Library/StdDriver/src/fmc.c"
uint32_t FMC_Read(uint32_t u32Addr)
{
    int32_t tout;

    g_FMC_i32ErrCode = eFMC_ERRCODE_SUCCESS;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x00UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0u;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1u;
...
# 565 "../../../../Library/StdDriver/src/fmc.c"
void FMC_Write(uint32_t u32Addr, uint32_t u32Data)
{
    int32_t tout;
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x21UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = u32Data;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1u;
...
# 609 "../../../../Library/StdDriver/src/fmc.c"
uint32_t FMC_Write128(uint32_t u32Addr, uint32_t pu32Buf[])
{
    int32_t tout;
    ...
    idx = 0u;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x27UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;
    ...
    do
    {
        ...
        err = 0;
        u32OnProg = 1u;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT0 = pu32Buf[idx + 0u];
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT1 = pu32Buf[idx + 1u];
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT2 = pu32Buf[idx + 2u];
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT3 = pu32Buf[idx + 3u];
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1u;
        idx += 4u;

        for (i = idx; i < 128u / 4u; i += 4u)
        {
            __set_PRIMASK(1u);
            ...
            do
            {
                if ((((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPSTS & (0x1ul << (0))) == 0u)
                {
                    __set_PRIMASK(0u);

                    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPADDR & (~0xful);
                    idx = (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR - u32Addr) / 4u;
                    err = -1;
                }

            } while ((tout-- > 0) && (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPSTS & (3u << (4))) && (err == 0));
            ...
            if (err == 0)
            {
                ...
                ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT0 = pu32Buf[i];
                ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT1 = pu32Buf[i + 1u];
                ...
                } while ((tout-- > 0) && (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPSTS & (3u << (6))) && (err == 0));
                ...
                if (err == 0)
                {
                    ...
                    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT2 = pu32Buf[i + 2u];
                    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->MPDAT3 = pu32Buf[i + 3u];
                    __set_PRIMASK(0u);
                }
            }
