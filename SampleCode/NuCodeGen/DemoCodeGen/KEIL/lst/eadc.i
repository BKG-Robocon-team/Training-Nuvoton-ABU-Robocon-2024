# 1 "../../../../Library/StdDriver/src/eadc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../Library/StdDriver/src/eadc.c" 2
...
# 10 "../../../../Library/StdDriver/src/eadc.c" 2
# 19 "../../../../Library/StdDriver/src/eadc.c"
int32_t g_EADC_i32ErrCode = 0;
# 34 "../../../../Library/StdDriver/src/eadc.c"
void EADC_Open(EADC_T *eadc, uint32_t u32InputMode)
{
...
# 98 "../../../../Library/StdDriver/src/eadc.c"
...
# 121 "../../../../Library/StdDriver/src/eadc.c"
void EADC_SetTriggerDelayTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32TriggerDelayTime, uint32_t u32DelayClockDivider)
...
# 140 "../../../../Library/StdDriver/src/eadc.c"
void EADC_SetExtendSampleTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32ExtendSampleTime)
{
    if (u32ModuleNum < 16)
    {
    ...
    {
        ((eadc->SCTL0[u32ModuleNum - 16])) &= (~(0xfful << (24)));
        ((eadc->SCTL0[u32ModuleNum - 16])) |= (u32ExtendSampleTime << (24));
    }
}
